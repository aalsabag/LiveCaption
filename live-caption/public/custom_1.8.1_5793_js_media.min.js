    ...
    return function(e) {
            ...
            var i = n(2),
                ...
                s = function(e, t, n) {
                    var d, c, l, f = e & s.F,
                        ...
                        A = h ? r : r[t] || (r[t] = {}),
                        I = A.prototype,
                        D = h ? i : _ ? i[t] : (i[t] || {}).prototype;
                    for (d in h && (n = t), n)(c = !f && D && void 0 !== D[d]) && u(A, d) || (l = c ? D[d] : n[d], A[d] = h && "function" != typeof D[d] ? n[d] : p && c ? a(l, i) : S && D[d] == l ? function(e) {
        ...
        function(e, t, n) {
            ...
            a.prototype = {
                publish: function() {
                    return r.
                    default.publish.apply(this, arguments)
                },
                publishSync: function() {
                    return r.
                    default.publishSync.apply(this, arguments)
                },
                trigger: function() {
                ...
                subscribe: function() {
                    return r.
                    default.subscribe.apply(this, arguments)
                },
                on: function() {
                ...
                unsubscribe: function() {
                    return r.
                    default.unsubscribe.apply(this, arguments)
                },
                clearAllSubscriptions: function() {
                    r.
                    default.clearAllSubscriptions()
                }
            };
            var o = new a;
            t.
        ...
        function(e, t, n) {
            ...
            var r = i(n(159)),
                ...
                s = 1e3,
                d = 1,
                c = "object" === ("undefined" == typeof localStorage ? "undefined" : (0, a.
                    default)(localStorage)) && localStorage.__islogdebug,
                l = "object" === ("undefined" == typeof localStorage ? "undefined" : (0, a.
                    default)(localStorage)) && localStorage.__islogdebug;
            ...
            var h = function(e, t) {
                ...
                var i = function() {
                    var t;
                    l && (t = console).log.apply(t, [e].concat((0, r.
                        default)(n(arguments))))
                };
                return ["log", "info", "warn", "error"].forEach(function(t) {
                    i[t] = function() {
                        var i;
                        l && (i = console)[t].apply(i, [e].concat((0, r.
                            default)(n(arguments))))
                    }
                }), i.isEnable = function() {
                    return l
        ...
        function(e, t, n) {
            ...
            var f, h, _ = function() {
                    ...
                    if (e.mozGetUserMedia) t.browser = "firefox", t.version = c(e.userAgent, /Firefox\/(\d+)\./, 1);
                    else if (e.webkitGetUserMedia) t.browser = "chrome", t.version = c(e.userAgent, /Chrom(e|ium)\/(\d+)\./, 2);
                    else if (e.mediaDevices && e.userAgent.match(/Edge\/(\d+).(\d+)$/)) t.browser = "edge", t.version = c(e.userAgent, /Edge\/(\d+).(\d+)$/, 2);
                    else {
                        if (!window.RTCPeerConnection || !e.userAgent.match(/AppleWebKit\/(\d+)\./)) return t.browser = "Not a supported browser.", t;
                        t.browser = "safari", t.version = c(e.userAgent, /AppleWebKit\/(\d+)\./, 1)
                    }
                    return t
                }(),
                E = {
                    ...
                    browserType: _,
                    browser: {
                        isFirefox: "firefox" === _.browser,
                        isChrome: "chrome" === _.browser,
                        isEdge: "edge" === _.browser,
                        isSafari: "safari" === _.browser
                    },
                    isOpera65: function() {
                        try {
                    ...
                    isSDKSupportSIMD: (f = (0, o.
                        ...
                        default.mark(function e() {
                            ...
                            default.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        if ("object" === ("undefined" == typeof WebAssembly ? "undefined" : (0, r.
                                            default)(WebAssembly))) {
                                            e.next = 2;
                                            break
                                        }
                    ...
                    stringSplitByComma2Buffer: function(e) {
                        try {
                            for (var t = e.split(",").map(function(e) {
                                return parseInt(e)
                            }), n = new ArrayBuffer(t.length), i = new Uint8Array(n), r = 0; r < t.length; r++) i[r] = t[r];
                            return n
                        } catch (e) {
                            return null
                        }
                    ...
                    getBrowserVersion: function() {
                        return function() {
                            ...
                            if (e.indexOf("safari") > 0 && e.indexOf("chrome") < 0) {
                                var t, n = "safari/unknow";
                                return n = e.match(/safari\/[\d.]+/gi), t = e.match(/safari\/[\d.]+/gi), n && (n = n.toString().replace("version", "safari")), t && (n = t.toString().replace("version", "safari")), n
                            }
                            return e.indexOf("chrome") > 0 ? e.match(/chrome\/[\d.]+/gi) : "other"
                        }()[0].match(/(\d\d)/)[0]
                    },
                    isSupportImageCapture: function() {
                        return "function" == typeof ImageCapture && "function" == typeof OffscreenCanvas && !l()
                    }
                };
            t.
            default = E
        ...
        function(e, t, n) {
            ...
            e.exports = function(e) {
                return null == e ? void 0 === e ? u : o : s && s in Object(e) ? r(e) : a(e)
            }
        },
        function(e, t) {
        ...
        function(e, t, n) {
            ...
            e.exports = function(e, t, n, _, E, p, S) {
                ...
                var A, I, D, v = function(e) {
                    ...
                    y = R || v(E),
                    T = E ? g ? v("entries") : y : void 0,
                    M = "Array" == t && C.entries || R;
                if (M && (D = c(M.call(new e))) !== Object.prototype && D.next && (d(D, O, !0), i || "function" == typeof D[l] || o(D, l, h)), g && R && "values" !== R.name && (m = !0, y = function() {
                    return R.call(this)
                }), i && !S || !f && !m && C[l] || o(C, l, y), u[t] = y, u[O] = h, E)
                    if (A = {
                        values: g ? y : v("values"),
                        keys: p ? y : v("keys"),
                        entries: T
        ...
        function(e, t, n) {
            ...
            var r = i(n(8)),
                ...
                u = function() {
                    function e() {
                        (0, a.
                            default)(this, e), this.handler = !1, this.wasm = !1, this.socket = !1
                    }
                    return (0, o.
                        default)(e, [{
                        ...
                        value: function() {
                            ...
                            return new r.
                            default (function(t, n) {
                                if (e.checkInitSuccess()) return t(!0);
                                var i = 0,
                                    r = setInterval(function() {
                                        i++ > 120 && (n("wait for init success timeout", 120), clearInterval(r)), e.checkInitSuccess() && (t(!0), clearInterval(r))
                                    }, 500)
                            })
                        }
                    }]), e
        ...
        function(e, t, n) {
            ...
            var h = function(e) {
                ...
                return (0, d.
                    ...
                    value: function() {
                        l.
                        default.triggerSync(f.SHARING_DECODE_SUCCESS)
                    }
                }, {
                    key: "publishSharingDecodeFailedEvent",
                    value: function() {
                        l.
                        default.triggerSync(f.SHARING_DECODE_FAILED)
                    }
                }, {
                    key: "publishSharingEncodeSuccessEvent",
                    value: function() {
                        l.
                        default.triggerSync(f.SHARING_ENCODE_SUCCESS)
                    }
                }, {
                    key: "publishSharingEncodeFailedEvent",
                    value: function() {
                        l.
                        default.triggerSync(f.SHARING_ENCODE_FAILED)
                    }
                }]), t
            }(c.
                default);
                ...
                return (0, o.
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            l.
                            default.on(f.SHARING_DECODE_SUCCESS, function() {
                                e(!0)
                            })
                        })
                    }
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            ...
                            default.on(f.SHARING_DECODE_FAILED, function() {
                                e(!1)
                            })
                        })
                    }
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            l.
                            default.on(f.SHARING_ENCODE_SUCCESS, function() {
                                e(!0)
                            }), l.
                            default.on(f.SHARING_ENCODE_FAILED, function() {
                                e(!1)
                            })
                        })
                    }
        ...
        function(e, t, n) {
            ...
            var a = r(n(96)),
                ...
                d = function() {
                    function e() {
                        this.base_time = null, this.monitor = "", this.last_get_monitor_time = 0, this.checkIsNecessaryLogMap = new o.
                        default, this.highfrequencyerror = new o.
                        default
                    }
                    return e.prototype = {
                        init: function() {
                            this.base_time = (new Date).getTime() / 1e3, this.checkIsNecessaryLogMap = new o.
                            default
                        },
                        ...
                        send_instant_monitor: function() {
                            ...
                            e && s.
                            default.Notify_APPUI(u.MONITOR_LOG, {
                                evt: 4167,
                                seq: 1,
                                body: {
                                    data: e
                        ...
                        checkIsNecessaryExceptionLogAndReturnRepeatTimes: function(e) {
                            ...
                            try {
                                ...
                                if (this.checkIsNecessaryLogMap.set(e, r + 1), this.checkIsNecessaryLogMap.size > 200) {
                                    var o = (0, a.
                                        default)(this.checkIsNecessaryLogMap.keys()).slice(0, 20);
        ...
        function(e, t, n) {
            ...
            var h = function() {
                ...
                return (0, d.
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            c.
                            default.on(f.VIDEO_ENCODE_INIT_SUCCESS, function() {
                                return e(!0)
                            })
                        })
                    }
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            c.
                            default.on(f.VIDEO_DECODE_INIT_SUCCESS, function() {
                                return e(!0)
                            })
                        })
                    }
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            ...
                            default.on(f.VIDEO_ENCODE_INIT_FAILED, function() {
                                return e(!1)
                            })
                        })
                    }
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            ...
                            default.on(f.VIDEO_DECODE_INIT_FAILED, function() {
                                return e(!1)
                            })
                        })
                    }
                    ...
                    value: function() {
                        return u.
                        default.all([e.onVideoEncodeInitSuccess(), e.onVideoDecodeInitSuccess()])
                    }
                }]), e
            }();
            t.Video = h;
            var _ = function(e) {
                ...
                return (0, o.
                    ...
                    value: function() {
                        c.
                        default.publishSync(f.VIDEO_ENCODE_INIT_SUCCESS)
                    }
                }, {
                    key: "publishDecodeInitSuccessEvent",
                    value: function() {
                        c.
                        default.publishSync(f.VIDEO_DECODE_INIT_SUCCESS)
                    }
                }, {
                    key: "publishEncodeInitFAILEDEvent",
                    value: function() {
                        c.
                        default.publishSync(f.VIDEO_ENCODE_INIT_FAILED)
                    }
                }, {
                    key: "publishDecodeInitFAILEDEvent",
                    value: function() {
                        c.
                        default.publishSync(f.VIDEO_DECODE_INIT_FAILED)
                    }
                }]), t
            }(l.
                default);
        ...
        function(e, t, n) {
            ...
            var h = function(e) {
                ...
                return (0, d.
                    ...
                    value: function() {
                        l.
                        default.triggerSync(f.AUDIO_ENCODE_SUCCESS)
                    }
                }, {
                    key: "publishAudioDecodeSuccessEvent",
                    value: function() {
                        l.
                        default.triggerSync(f.AUDIO_DECODE_SUCCESS)
                    }
                }, {
                    key: "publishAudioEncodeFAILEDEvent",
                    value: function() {
                        l.
                        default.triggerSync(f.AUDIO_ENCODE_FAILED)
                    }
                }, {
                    key: "publishAudioDecodeFAILEDEvent",
                    value: function() {
                        l.
                        default.triggerSync(f.AUDIO_DECODE_FAILED)
                    }
                }]), t
            }(c.
                default);
            ...
            var _ = function() {
                ...
                return (0, o.
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            l.
                            default.on(f.AUDIO_ENCODE_SUCCESS, function() {
                                e(!0)
                            })
                        })
                    }
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            l.
                            default.on(f.AUDIO_DECODE_SUCCESS, function() {
                                e(!0)
                            })
                        })
                    }
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            ...
                            default.on(f.AUDIO_ENCODE_FAILED, function() {
                                e(!1)
                            })
                        })
                    }
                    ...
                    value: function() {
                        ...
                        default (function(e, t) {
                            ...
                            default.on(f.AUDIO_DECODE_FAILED, function() {
                                e(!1)
                            })
                        })
                    }
        ...
        function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.MAIN_WORKER_COMMAND = t.WORKER_TYPE = t.workerStartTypeToDevToolWorkerNameEnum = t.OS_ENUM = t.ConnectionType = t.EncodeDecodeEnum = t.ZOOM_CONNECTION_TYPE = void 0;
        ...
        function(e, t, n) {
            ...
            function s() {
                this.ssrcQueueMap = new r.
                default, s.prototype.AddQueue = function(e) {
                    var t = new a.
                    default;
            ...
            var c = function() {
                this.ssrcInfoMap = new r.
                default
            };

            function l() {
                this.ssrcQueueMap = new r.
                default, this.ssrcInfo = new c, l.prototype.AddQueue = function(e) {
                    var t = new a.
                    default;
                    return this.ssrcQueueMap.set(e, t), t
            ...
            var f = function() {
                function e() {
                    this.map = new r.
                    default, this.AudioQueueMGR = new s, this.timemap = new r.
                    default
                }
            ...
            function h() {
                this.map = new r.
                default, this.VideoQueueMGR = new l
            }
            ...
            function p() {
                this.ssrcQueueMap = new r.
                default, this.ssrcInfo = new E, p.prototype.AddQueue = function(e) {
                    var t = new a.
                    default;
                    return this.ssrcQueueMap.set(e, t), t
            ...
            function S() {
                this.map = new r.
                default, this.sQueue = new a.
                default, this.SharingQueueMGR = new p
            }
        ...
        function(e, t, n) {
            ...
            default = void 0, i.prototype.getLength = function() {
        ...
        function(e, t, n) {
            ...
            e.exports = function(e) {
                ...
                e = e.replace(o, "");
                var n = s.test(e);
                return n || d.test(e) ? c(e.slice(2), n ? 2 : 8) : u.test(e) ? a : +e
            }
        },
        function(e, t, n) {
            var i = n(101).Symbol;
        ...
        function(e, t, n) {
            var i = n(36),
                ...
                a = "[object Number]";
            e.exports = function(e) {
                return "number" == typeof e || r(e) && i(e) == a
            }
        },
        function(e, t, n) {
            "use strict";
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                var t = O.
                default.userNodeList || [], n = e.concat(t);
                O.
                default.userNodeList = f.
                default.removeDuplicates(n, function(e, t) {
                    return e.userid !== t.userid
                }), [D.WORKER_TYPE.AUDIO_ENCODE, D.WORKER_TYPE.AUDIO_DECODE, D.WORKER_TYPE.VIDEO_ENCODE, D.WORKER_TYPE.VIDEO_DECODE, D.WORKER_TYPE.SHARING_ENCODE, D.WORKER_TYPE.SHARING_DECODE].forEach((i = (0, d.
                    default)(s.
                    default.mark(function e(t) {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    e.t0 = t, e.next = e.t0 === D.WORKER_TYPE.AUDIO_ENCODE ? 3 : e.t0 === D.WORKER_TYPE.AUDIO_DECODE ? 5 : e.t0 === D.WORKER_TYPE.VIDEO_ENCODE ? 7 : e.t0 === D.WORKER_TYPE.VIDEO_DECODE ? 9 : e.t0 === D.WORKER_TYPE.SHARING_ENCODE ? 11 : e.t0 === D.WORKER_TYPE.SHARING_DECODE ? 13 : 15;
                                    break;
                                case 3:
                                    return n = O.
                                default.audioEncodeInitInstance, e.abrupt("break", 15);
                                case 5:
                                    return n = O.
                                default.audioDecInitInstance, e.abrupt("break", 15);
                                case 7:
                                    return n = O.
                                default.videoInitInstance, e.abrupt("break", 15);
                                case 9:
                                    return n = O.
                                default.videoDecInitInstance, e.abrupt("break", 15);
                                case 11:
                                    return n = O.
                                default.sharingEncInitInstance, e.abrupt("break", 15);
                                case 13:
                                    return n = O.
                                default.sharingDecInitInstance, e.abrupt("break", 15);
                                case 15:
                                    return e.prev = 15, e.next = 18, n.waitforInitSuccess();
                                case 18:
                                    g("setUserNodeListToWorker init success", t), Oe(t, {
                                        userNodeList: O.
                                        default.userNodeList
                                    }, D.MAIN_WORKER_COMMAND.SET_USER_NODE_LIST, !1, !0), e.next = 25;
                                    break;
                                case 22:
                                    e.prev = 22, e.t1 = e.
                                    catch (15), g(e.t1);
                ...
                O.
                default.isAudioPlayWork = e
            }, t.UpdateVideoPlayStatus = function(e) {
                O.
                default.isVideoPlayWork = e
            }, t.UpdateSharingPlayStatus = function(e) {
                O.
                default.isSharingPlayWork = e
            }, t.ClearSharingBuffer = function() {
                O.
                default.localSharingDecMGR && O.
                default.localSharingDecMGR.ClearBuffer()
            }, t.SetLocalAudioPara = function(e) {
                O.
                default.localAudioPara = e
                ...
                e.videoDecWorkerPath && (O.
                    default.TotalWaitEvent += 6);
                e.audioDecWorkerPath && (O.
                    default.TotalWaitEvent += 6);
                e.imageDecWorkerPath && (O.
                    default.TotalWaitEvent += 3)
            }, t.JsSharingEngine_PreInit = function(e) {
                O.
                default.localSharingDecMGR || (O.
                    default.localSharingDecMGR = new l.SharingMGR);
                O.
                default.localMouseDecMGR || (O.
                    default.localMouseDecMGR = new l.SharingMGR);
                O.
                default.sharingDecWorkerPath = e.imageDecWorkerPath, $()
            }, t.Sharing_Decode_Post_message = K, t.Sharing_Encode_Post_message = B, t.JsAudioEngine_PreInit = function(e) {
                return te.apply(this, arguments)
            }, t.JsSharingEngine_Init = function(e, t) {
                O.
                default.localSharingPara || (O.
                    default.localSharingPara = t);
                O.
                default.localSharingDecMGR || (O.
                    default.localSharingDecMGR = new l.SharingMGR);
                O.
                ...
                O.
                default.localSharingPara ? (0, o.
                    default)(O.
                    default.localSharingPara, t) : O.
                default.localSharingPara = t;
                ie(e)
            }, t.JsAudioEngine_Init = function(e, t) {
                O.
                default.localAudioPara || (O.
                    default.localAudioPara = t);
                O.
                default.localAudioDecMGR || (O.
                    default.localAudioDecMGR = new l.AudioMGR);
                O.
                default.localAudioEncMGR || (O.
                    default.localAudioEncMGR = new l.AudioMGR);
                ne(e), Se(0)
            }, t.setAudioEngineInitProperties = function(e, t) {
                O.
                default.localAudioPara ? (0, o.
                    default)(O.
                    default.localAudioPara, t) : O.
                default.localAudioPara = t;
                ne(e)
            }, t.setVideoEngineInitProperties = function(e, t) {
                O.
                default.localVideoPara ? (0, o.
                    default)(O.
                    default.localVideoPara, t) : O.
                default.localVideoPara = t;
                n = e, O.
                default.Video_WebSocket_Ip_Address || (O.
                    default.Video_WebSocket_Ip_Address = n);
                var n
            }, t.JsAudioEngine_UnInit = function() {
                (function(e) {
                    if (e = O.
                        default.SPECIAL_ID, O.
                        default.localAudioEncMGR) {
                        var t = O.
                        default.localAudioEncMGR.map.get(e);
                        t && (t.postMessage({
                                command: "closeMedia"
                            }), O.
                            default.localAudioEncMGR.map.delete(e)), O.
                        default.isAudioEncodePostStart = !1
                    }
                })(O.
                    default.SPECIAL_ID),
                function(e) {
                    if (e = O.
                        default.SPECIAL_ID, O.
                        default.localAudioDecMGR) {
                        var t = O.
                        default.localAudioDecMGR.map.get(O.
                            default.SPECIAL_ID);
                        t && (t.postMessage({
                                command: "closeMedia"
                            }), O.
                            default.localAudioDecMGR.map.delete(e)), O.
                        default.isAudioDecodePostStart = !1
                    }
                }(O.
                    default.SPECIAL_ID), O.
                default.localAudioDecMGR = null, O.
                default.localAudioEncMGR = null
            }, t.JsVideoEngine_UnInit = function() {
                (function(e) {
                    if (e = O.
                        default.SPECIAL_ID, O.
                        default.localVideoDecMGR) {
                        var t = O.
                        default.localVideoDecMGR.map.get(e);
                        t && (t.postMessage({
                                command: "closeMedia"
                            }), O.
                            default.localVideoDecMGR.map.delete(e)), O.
                        default.isVideoDecodePostStart = !1
                    }
                })(O.
                    default.SPECIAL_ID), O.
                default.localVideoDecMGR = null, O.
                default.localVideoEncMGR = null
                ...
                ! function() {
                    ...
                    if (O.
                        ...
                        var t = O.
                        default.localSharingDecMGR.Get(e);
                        t && (t.postMessage({
                                command: "closeMedia"
                            }), O.
                            default.localSharingDecMGR = null), O.
                        default.isSharingDecodeThreadStart = !1
                    }
                }()
                ...
                if (O.
                    default.localVideoEncMGR) {
                    var r = O.
                    default.localVideoEncMGR.map.get(e);
                    if (r) {
                        var a = {
                ...
                if (O.
                    ...
                    var o, u = O.
                    default.localSharingEncMGR.map.get(e);
                    if (u) t ? (o = {
                ...
                if (O.
                    default.localSharingDecMGR) return O.
                default.localSharingDecMGR.SharingQueueMGR.ClearQueue();
                if (O.
                    default.localMouseDecMGR) return O.
                default.localMouseDecMGR.SharingQueueMGR.ClearQueue();
                return 0
            }, t.Get_Decoded_Audio_Buffer_Length = oe, t.Get_Decoded_Audio_Frame = function(e, t, n) {
                if (!O.
                    default.localAudioDecMGR) return;
                e = O.
                default.SPECIAL_ID;
                var i = n,
                    r = O.
                default.localAudioDecMGR.AudioQueueMGR.GetQueue(e), a = null;
                if (r) {
                    if (r.residue) {
                    ...
                    for (var o = r.dequeue(); o && o.buffer.length < n;) ue(o.ntptime), a = T(a, o.buffer), n -= o.buffer.length, o = r.dequeue();
                    if (o && (ue(o.ntptime), 0 !== n && o.buffer.length === n ? a = T(a, o.buffer) : 0 !== n && o.buffer.length > n && (a = T(a, o.buffer.slice(0, n)), r.residue = {
                ...
                (function() {
                    ...
                    default.SPECIAL_ID;
                    if (!O.
                        default.localAudioEncMGR) return;
                    var t = O.
                    default.audio_pcm_queue.dequeue();
                    for (; t;) {
                        var n = O.
                        default.localAudioEncMGR.map.get(e);
                        O.
                        default.isAudioEncodeWASMOK && n && n.postMessage(t, [t.data.buffer]), t = O.
                        default.audio_pcm_queue.dequeue()
                    }
                })(), clearInterval(O.
                    default.audioPostInterval), O.
                default.audioPostInterval = null
            }, t.Add_Audio_Decode_Thread = _e, t.Get_SSRC_Latest_Time = Ee, t.Get_Video_SSRC_Latest_Time = function(e) {
                var t;
                t = "function" == typeof AudioWorklet ? O.
                default.CurrentSSRCTime : Ee(e);
                return t
            }, t.Meeting_Fail_Over = function(e, t) {
                var n = O.
                default.SPECIAL_ID, i = O.
                default.localVideoDecMGR.map.get(n);
                i.postMessage({
                    command: "failover",
                    websocket_ip_address: t
                }), (i = O.
                    default.localAudioDecMGR.map.get(n)).postMessage({
                    command: "failover",
                ...
                default.audio_pcm_queue.dequeue();
                O.
                default.localAudioEncMGR && (t = O.
                    default.localAudioEncMGR.map.get(n)) && O.
                default.isAudioEncodePostStart && t.postMessage({
                    command: "modifySampleRate",
                    sampleRate: e
                });
                O.
                default.localAudioDecMGR && (t = O.
                    default.localAudioDecMGR.map.get(n)) && O.
                default.isAudioDecodePostStart && t.postMessage({
                    command: "modifySampleRate",
                    sampleRate: e
                })
                ...
                if (e = O.
                    ...
                    default.localAudioDecMGR) {
                    var n = O.
                    default.localAudioDecMGR.map.get(e);
                    n && n.postMessage({
                        command: "mute",
                        bOn: t
                    })
                ...
                if (O.
                    default.localAudioDecMGR) {
                    var i = O.
                    default.localAudioDecMGR.map.get(n);
                    i && i.postMessage({
                ...
                if (O.
                    default.localAudioEncMGR) {
                    var i = O.
                    default.localAudioEncMGR.map.get(n);
                    i && i.postMessage({
                ...
                if (O.
                    default.localAudioDecMGR) {
                    var n = O.
                    default.localAudioDecMGR.map.get(t);
                    n && n.postMessage({
                ...
                if (O.
                    default.localVideoDecMGR) {
                    var n = O.
                    default.localVideoDecMGR.map.get(t);
                    n && n.postMessage({
                ...
                if (O.
                    default.localVideoEncMGR) {
                    var n = O.
                    default.localVideoEncMGR.map.get(t);
                    n && n.postMessage(e)
                }
                ...
                if (O.
                    default.localSharingDecMGR) {
                    var n = O.
                    default.localSharingDecMGR.map.get(t);
                    n && n.postMessage(e)
                }
            ...
            }, t.Notify_Audio_Encode_Thread = function(e) {
                var t = O.
                default.SPECIAL_ID;
                if (O.
                    default.localAudioEncMGR) {
                    var n = O.
                    default.localAudioEncMGR.map.get(t);
                    n && n.postMessage(e)
                }
                ...
                var e = O.
                default.SPECIAL_ID, t = 20;
                O.
                default.audioDelay && (t = O.
                    default.audioDelay);
                if (O.
                    default.localAudioEncMGR) {
                    var n = O.
                ...
                I.
                default.init(), window.addEventListener("error", Ie),
                function() {
                    try {
                        I.
                        default.add_monitor(["BSAGT:", navigator.userAgent].join("")), I.
                        default.add_monitor("BSLITEND:" + (f.
                            default.isLittleEndian() ? 1 : 0)), window.navigator.hardwareConcurrency && I.
                        default.add_monitor("OSCPUS:" + window.navigator.hardwareConcurrency)
                    } catch (e) {}
                }(), O.
                default.monitorIntervalHandle = setInterval(function() {
                    var e, t = I.
                    default.get_monitor();
                    (t && O.
                        default.Notify_APPUI(c.MONITOR_LOG, {
                            evt: 4167,
                            seq: 1,
                            body: {
                                data: t
                        ...
                        default.monitorAudioCapture || null != O.
                        default.monitorEncodeVideo || null != O.
                        default.monitorDecodeVideo || null != O.
                        default.monitorVideoCapture || null != O.
                        default.monitorEncodeSharing || null != O.
                        default.monitorDecodeSharing || null != O.
                        default.monitorSharingEncodeAPPInfo || null != O.
                        default.monitorVideoDecodeAPPInfo || null != O.
                        default.monitorVideoEncodeAPPInfo) && (null != O.
                        default.monitorVideoCapture && (e = Ae(e = "CAMERA," + O.
                                default.monitorVideoUserID + ",0,webcam," + O.
                                default.monitorVideoCapture, 7), e += ",{[END]}", O.
                            default.Notify_APPUI(c.MONITOR_LOG, {
                                evt: 4167,
                                seq: 1,
                                body: {
                            ...
                            default.monitorVideoCapture = null), null != O.
                        default.monitorAudioCapture && (e = "AUDIOD," + O.
                            default.monitorAudioUserID + ",1,0,wclaudi,0," + O.
                            default.monitorAudioCapture + ",0", e += ",{[END]}", O.
                            default.Notify_APPUI(c.MONITOR_LOG, {
                                evt: 4167,
                                seq: 1,
                                body: {
                            ...
                            default.monitorAudioCapture = null), null == O.
                        default.monitorEncodeVideo && null == O.
                        default.monitorDecodeVideo || null == O.
                        default.monitorVideoUserID || (e = "MCM_VIDEO," + O.
                            default.monitorVideoUserID + ",0,0,0", e = null != O.
                            default.monitorEncodeVideo ? (e = Ae(e = e + ",{[SEND]}," + O.
                                default.monitorEncodeVideo.monitor_video_max_sub_for_me + "," + O.
                                default.monitorEncodeVideo.video_width + "," + O.
                                default.monitorEncodeVideo.video_height + "," + O.
                                default.monitorEncodeVideo.max_fps + "," + O.
                                default.monitorEncodeVideo.min_fps + "," + O.
                                default.monitorEncodeVideo.avg_fps, 12)) + "," + O.
                            default.monitorEncodeVideo.video_encoded_max_fps + "," + O.
                            default.monitorEncodeVideo.video_encoded_min_fps + "," + O.
                            default.monitorEncodeVideo.video_encoded_avg_fps + "," + O.
                            default.monitorEncodeVideo.video_encoded_width + "," + O.
                            default.monitorEncodeVideo.video_encoded_heigth + "," + O.
                            default.monitorEncodeVideo.video_total_encoded_frames + "," + O.
                            default.monitorEncodeVideo.video_send_buffer : Ae(e += ",{[SEND]}", 25), e = Ae(e += ",{[RTS]}", 5), e = Ae(e += ",{[VC]}", 12), null != O.
                            default.monitorEncodeVideo ? e += ",{[ENCO]}," + O.
                            default.monitorEncodeVideo.monitor_video_max_encode_time + "," + O.
                            default.monitorEncodeVideo.monitor_video_min_encode_time + "," + O.
                            default.monitorEncodeVideo.monitor_video_avg_encode_time + "," + O.
                            default.monitorEncodeVideo.monitor_video_sdev_encode_time : e = Ae(e += ",{[ENCO]}", 4), null != O.
                            default.monitorDecodeVideo ? (e = Ae(e += ",{[RECV]}", 16), e = (e = Ae(e = e + "," + O.
                                    default.monitorDecodeVideo.max_fps + "," + O.
                                    default.monitorDecodeVideo.min_fps + "," + O.
                                    default.monitorDecodeVideo.avg_fps + "," + O.
                                    default.monitorDecodeVideo.video_width + "," + O.
                                    default.monitorDecodeVideo.video_height + "," + O.
                                    default.monitorDecodeVideo.monitor_video_max_size, 5)) + "," + O.
                                default.monitorDecodeVideo.monitor_video_max_size) : e = Ae(e += ",{[RECV]}", 28), e = Ae(e += ",{[VQ]}", 13), null != O.
                            default.monitorDecodeVideo ? e += ",{[DECO]}," + O.
                            default.monitorDecodeVideo.monitor_video_max_decoding_time + "," + O.
                            default.monitorDecodeVideo.monitor_video_min_decoding_time + "," + O.
                            default.monitorDecodeVideo.monitor_video_avg_decoding_time + "," + O.
                            default.monitorDecodeVideo.monitor_video_sdev_decoding_time : e = Ae(e += ",{[DECO]}", 4), O.
                            default.monitorDecodeVideo = null, O.
                            default.monitorEncodeVideo = null, e += ",{[END]}", O.
                            default.Notify_APPUI(c.MONITOR_LOG, {
                                evt: 4167,
                                seq: 1,
                                body: {
                        ...
                        default.monitorEncodeSharing && null == O.
                        default.monitorDecodeSharing || null == O.
                        default.monitorSharingUserID || (e = "MCM_AS," + O.
                            default.monitorSharingUserID + ",,", O.
                            default.monitorEncodeSharing && (e = (e = e + ",{[SEND]}," + O.
                                    default.monitorEncodeSharing.sharing_max_sub_for_me + "," + O.
                                    default.monitorEncodeSharing.sharing_width + "," + O.
                                    default.monitorEncodeSharing.sharing_height + "," + O.
                                    default.monitorEncodeSharing.max_fps + "," + O.
                                    default.monitorEncodeSharing.min_fps + "," + O.
                                    default.monitorEncodeSharing.avg_fps + ",,,," + O.
                                    default.monitorEncodeSharing.sharing_encoded_max_fps + "," + O.
                                    default.monitorEncodeSharing.sharing_encoded_min_fps + "," + O.
                                    default.monitorEncodeSharing.sharing_encoded_avg_fps + ",,,,,,,,," + O.
                                    default.monitorEncodeSharing.sharing_encode_total_frames + ",,," + O.
                                    default.monitorEncodeSharing.monitor_stream_index) + ",{[ENCO]}," + O.
                                default.monitorEncodeSharing.sharing_max_encoding_time + "," + O.
                                default.monitorEncodeSharing.sharing_min_encoding_time + "," + O.
                                default.monitorEncodeSharing.sharing_avg_encoding_time + "," + O.
                                default.monitorEncodeSharing.sharing_sdev_encoding_time), O.
                            default.monitorDecodeSharing && (e = e + ",{[RECV]}," + O.
                                default.monitorDecodeSharing.max_fps + "," + O.
                                default.monitorDecodeSharing.min_fps + "," + O.
                                default.monitorDecodeSharing.avg_fps + "," + O.
                                default.monitorDecodeSharing.sharing_decode_width + "," + O.
                                default.monitorDecodeSharing.sharing_decode_height + "," + O.
                                default.monitorDecodeSharing.monitor_sharing_max_size), O.
                            default.monitorEncodeSharing = null, O.
                            default.monitorDecodeSharing = null, e += ",{[END]}", O.
                            default.Notify_APPUI(c.MONITOR_LOG, {
                                evt: 4167,
                                seq: 1,
                                body: {
                        ...
                        default.monitorSharingEncodeAPPInfo && (O.
                            default.Notify_APPUI(c.MONITOR_LOG, {
                                evt: 4167,
                                seq: 1,
                                body: {
                                    data: O.
                                    default.monitorSharingEncodeAPPInfo.data
                                }
                            }), O.
                            default.monitorSharingEncodeAPPInfo = null), null != O.
                        default.monitorVideoDecodeAPPInfo && (O.
                            default.Notify_APPUI(c.MONITOR_LOG, {
                                evt: 4167,
                                seq: 1,
                                body: {
                                    data: O.
                                    default.monitorVideoDecodeAPPInfo.data
                                }
                            }), O.
                            default.monitorVideoDecodeAPPInfo = null), null != O.
                        default.monitorVideoEncodeAPPInfo && (O.
                            default.Notify_APPUI(c.MONITOR_LOG, {
                                evt: 4167,
                                seq: 1,
                                body: {
                                    data: O.
                                    default.monitorVideoEncodeAPPInfo.data
                                }
                            }), O.
                            default.monitorVideoEncodeAPPInfo = null))
                }, 1e4)
            }, t.Send_Render_Monitor_Log = function(e) {
                I.
                default.add_monitor2(e)
            }, t.Stop_Monitor = function() {
                window.removeEventListener("error", Ie), clearInterval(O.
                    default.monitorIntervalHandle), I.
                default.send_instant_monitor()
                ...
                if (O.
                    default.localSharingEncMGR) {
                    var n = O.
                    default.localSharingEncMGR.Get(t);
                    n && n.postMessage({
                        command: "ENCRYPT",
                        encrypt: e
                    })
                ...
                if (!O.
                    default.localSharingEncMGR) return;
                var t = O.
                default.localSharingEncMGR.Get(O.
                    default.SPECIAL_ID);
                t && t.postMessage(e)
                ...
                [O.
                    default.localAudioDecMGR, O.
                    default.localAudioEncMGR, O.
                    default.localVideoDecMGR, O.
                    default.localVideoEncMGR, O.
                    default.localSharingDecMGR, O.
                    default.localSharingEncMGR
                ].forEach(function(t) {
                    if (t && t.map.get(e)) {
            ...
            }, t.pushMessageToWorker = Oe, t.isVideoEncodeHandleReady = function() {
                return null !== ve(D.WORKER_TYPE.VIDEO_ENCODE)
                ...
                if (O.
                    default.localVideoEncMGR) {
                    var i = O.
                    default.localVideoEncMGR.map.get(n);
                    i && i.postMessage({
            ...
            function m() {
                return (m = (0, d.
                    default)(s.
                    default.mark(function e(t, n, i, r, a) {
                        var u, d, c, l;
                        return s.
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    e.t0 = r, e.next = e.t0 === D.WORKER_TYPE.VIDEO_ENCODE ? 3 : e.t0 === D.WORKER_TYPE.VIDEO_DECODE ? 5 : e.t0 === D.WORKER_TYPE.AUDIO_ENCODE ? 7 : e.t0 === D.WORKER_TYPE.AUDIO_DECODE ? 9 : e.t0 === D.WORKER_TYPE.SHARING_DECODE ? 11 : e.t0 === D.WORKER_TYPE.SHARING_ENCODE ? 13 : 15;
                                    break;
                                case 3:
                                    return u = O.
                                default.videoEncResponseText, e.abrupt("break", 15);
                                case 5:
                                    return u = O.
                                default.videoDecResponseText, e.abrupt("break", 15);
                                case 7:
                                    return u = O.
                                default.audioEncodeResponse, e.abrupt("break", 15);
                                case 9:
                                    return u = O.
                                default.audioDecodeResponse, e.abrupt("break", 15);
                                case 11:
                                    return u = O.
                                default.sharingDecodeResponse, e.abrupt("break", 15);
                                case 13:
                                    return u = O.
                                default.sharingEncodeResponse, e.abrupt("break", 15);
                                case 15:
                                    if (u) {
                                        e.next = 19;
                                        break
                                    }
                                    return e.next = 18, C(t.workerJsFileUrl);
                                case 18:
                                    u = e.sent;
                                case 19:
                                    if (!a || !a.isDestroy) {
                                    ...
                                    return e.abrupt("return", g("WorkerType:".concat(r, ";The relative SDK instance is destroy, don't start relative worker, avoid multiple same workers. ")));
                                case 21:
                                    d = "wasmUrl = '" + t.workerWasmFileUrl + "';" + u, c = {}, D.workerStartTypeToDevToolWorkerNameEnum[r] && (0, o.
                                        default)(c, {
                                        name: D.workerStartTypeToDevToolWorkerNameEnum[r]
                                    }), l = new Worker(window.URL.createObjectURL(new Blob([d])), c), n && n.call(i, l);
                                case 26:
                                case "end":
                                    return e.stop()
                            }
            ...
            function R(e, t, n, i, r) {
                ! function(e, t, n, i, r) {
                    ...
                    var r = O.
                    default.SPECIAL_ID;
                    t && t.Add(r, e), e.onmessage = function(e) {
                        n(e),
                        function(e, t) {
                            var n = t.data;
            ...
            function y(e, t) {
                -1 !== [D.WORKER_TYPE.AUDIO_ENCODE, D.WORKER_TYPE.VIDEO_ENCODE, D.WORKER_TYPE.SHARING_ENCODE].indexOf(e) && t.status === c.AES_GCM_IV_CALLBACK_FROM_WASM && (g("allWorkersListener_AES_IV", e, t), O.
                    default.Notify_APPUI_SAFE(c.AES_GCM_IV_RESPONSE, {
                        workerType: e,
                        iv: f.
                        default.buffer2stringSplitByComma(t.data)
                    }))
            }
                ...
                return (M = (0, d.
                    ...
                    default.mark(function e(t) {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    if (g("video pre init", t), O.
                                        default.localVideoDecMGR || (O.
                                            default.localVideoDecMGR = new l.VideoMGR), O.
                                        default.localVideoEncMGR || (O.
                                            default.localVideoEncMGR = new l.VideoMGR), O.
                                        default.videoDecWorkerPath = t.videoDecWorkerPath, O.
                                        default.videoEncWorkerPath = t.videoEncWorkerPath, t.videoDecWorkerPath !== t.videoEncWorkerPath) {
                                        e.next = 13;
                                        break
                                    }
                                ...
                                case 8:
                                    n = e.sent, O.
                                default.videoDecResponseText = n, O.
                                default.videoEncResponseText = n, e.next = 18;
                                break;
                                case 13:
                                    return e.next = 15, u.
                                default.all([C(t.videoDecWorkerPath), C(t.videoEncWorkerPath)]);
                                case 15:
                                    i = e.sent, O.
                                default.videoDecResponseText = i[0], O.
                                default.videoEncResponseText = i[1];
                                case 18:
                                    O.
                                default.mediaSDKHandle = t.handle, fe(0, null);
                                case 20:
                                case "end":
                                    return e.stop()
                            }
                    ...
                    default.mark(function e(t, n) {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                ...
                                default.localVideoEncMGR || (O.
                                    default.localVideoEncMGR = new l.VideoMGR), O.
                                default.videoEncWorkerPath = t.workerJsFileUrl, e.next = 4, C(t.workerJsFileUrl);
                                case 4:
                                    return i = e.sent, O.
                                default.videoEncResponseText = i, fe(0, null, n, t), e.next = 9, P(n);
                                case 9:
                                    le();
                                case 10:
                                case "end":
            ...
            function P(e) {
                ...
                default (function(t, n) {
                    var i = setInterval(function() {
                        ...
                        O.
                        default.Video_WebSocket_Ip_Address && O.
                        default.localVideoPara && O.
                        default.localVideoPara.confId && (t(O.
                            default.Video_WebSocket_Ip_Address), clearInterval(i))
                    }, 1e3 / 24)
                })
            }
                    ...
                    default.mark(function e(t, n) {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                ...
                                default.localVideoDecMGR || (O.
                                    default.localVideoDecMGR = new l.VideoMGR), O.
                                default.videoDecWorkerPath = t.workerJsFileUrl, e.next = 4, C(t.workerJsFileUrl);
                                case 4:
                                    return i = e.sent, O.
                                default.videoDecResponseText = i, ce(0, null, n, t), e.next = 9, P(n);
                                case 9:
                                    de();
                                case 10:
                                case "end":
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return ee(), O.
                                default.localAudioEncMGR || (O.
                                    default.localAudioEncMGR = new l.AudioMGR), O.
                                default.audioEncWorkerPath = t.workerJsFileUrl, e.next = 5, C(t.workerJsFileUrl);
                                case 5:
                                    O.
                                default.audioEncodeResponse = e.sent, Se(0, n, t), w(n).then(function() {
                                    pe()
                                }).
                                catch (function(e) {
                                    g(e)
                ...
                return (L = (0, d.
                    ...
                    default.mark(function e(t) {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return e.abrupt("return", new u.
                                        default (function(e, n) {
                                            var i = setInterval(function() {
                                                if (t && t.isDestroy) return clearInterval(i), n("sdk destroy");
                                                var r = O.
                                                default.localAudioEncMGR.map.get(O.
                                                    default.SPECIAL_ID);
                                                O.
                                                default.localAudioPara && r && O.
                                                default.isAudioEncodeWASMOK && (clearInterval(i), e(!0))
                                            }, 1e3 / 24)
                                        }));
                                case 1:
                                case "end":
                                    ...
                                    return e.abrupt("return", new u.
                                        default (function(e, n) {
                                            var i = setInterval(function() {
                                                ...
                                                O.
                                                default.localAudioPara && r && O.
                                                default.isAudioDecodeWASMOK && (clearInterval(i), e(!0))
                                            }, 1e3 / 24)
                                        }));
                                case 1:
                                case "end":
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return ee(), O.
                                default.localAudioDecMGR || (O.
                                    default.localAudioDecMGR = new l.AudioMGR), O.
                                default.audioDecWorkerPath = t.workerJsFileUrl, e.next = 5, C(t.workerJsFileUrl);
                                case 5:
                                    O.
                                default.audioDecodeResponse = e.sent, _e(0, null, n, t), U(n).then(function() {
                                    he()
                                }).
                                catch (function(e) {
                                    g(e)
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return O.
                                default.localSharingDecMGR || (O.
                                    default.localSharingDecMGR = new l.SharingMGR), O.
                                default.localMouseDecMGR || (O.
                                    default.localMouseDecMGR = new l.SharingMGR), O.
                                default.sharingDecWorkerPath = t.workerJsFileUrl, e.next = 5, C(t.workerJsFileUrl);
                                case 5:
                                    O.
                                default.sharingDecodeResponse = e.sent, $(n, t), H(n).then(function() {
                                    K()
                                }).
                                catch (function(e) {
                                    g(e)
                    ...
                    default.mark(function e(t, n) {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return O.
                                default.localSharingEncMGR || (O.
                                    default.localSharingEncMGR = new l.SharingMGR), O.
                                default.sharingEncWorkerPath = t.workerJsFileUrl, e.next = 4, C(t.workerJsFileUrl);
                                case 4:
                                    O.
                                default.sharingEncodeResponse = e.sent, Z(n, t), F(n).then(function() {
                                    B()
                                }).
                                catch (function(e) {
                                    g(e)
            ...
            function F(e) {
                ...
                default (function(t, n) {
                    var i = setInterval(function() {
                        ...
                        default.localSharingEncMGR.Get(O.
                            default.SPECIAL_ID) && O.
                        default.isSharingEncodeWASMOK && O.
                        default.localSharingPara && (clearInterval(i), t(!0))
                    }, 1e3 / 24)
                })
            }
            ...
            function H(e) {
                ...
                default (function(t, n) {
                    var i = setInterval(function() {
                        if (e && e.isDestroy) return clearInterval(i), n("sdk destroy");
                        O.
                        default.localSharingDecMGR.Get(O.
                            default.SPECIAL_ID) && O.
                        default.isSharingDecodeWASMOK && O.
                        default.localSharingPara && (clearInterval(i), t(!0))
                    }, 1e3 / 24)
                })
            }
            ...
            function K() {
                if (O.
                    ...
                    e && O.
                    default.isSharingDecodeWASMOK && !O.
                    default.isSharingDecodePostStart ? (e.postMessage({
                            command: "startMedia",
                            websocket_ip_address: O.
                            default.Sharing_WebSocket_Ip_Address,
                            confId: O.
                            default.localSharingPara.userid,
                            confKey: "",
                            logon: O.
                            default.localSharingPara.logon,
                            meetingid: O.
                            default.localSharingPara.meetingid,
                            meetingnumb: O.
                            default.localSharingPara.meetingnumb,
                            multiThreadNum: 1
                        }), O.
                        default.isSharingDecodePostStart = !0) : O.
                    default.isSharingDecodePostStart || setTimeout(K, 100)
                }
            }
            ...
            function B() {
                if (O.
                    ...
                    if (e && O.
                        default.isSharingEncodeWASMOK && !O.
                        default.isSharingEncodePostStart) {
                        var t = O.
                        default.localSharingPara.isSupportMultiThread ? 4 : 1;
                        I.
                        default.add_monitor2("STN" + t);
                        var n = null;
                        O.
                        default.ivObj && (n = O.
                            default.ivObj[D.WORKER_TYPE.SHARING_ENCODE], n = f.
                            default.stringSplitByComma2Buffer(n)), e.postMessage({
                            command: "startMedia",
                            encode: !0,
                            websocket_ip_address: O.
                            default.Sharing_WebSocket_Ip_Address,
                            ...
                            default.localSharingPara.logon,
                            isChromeOrEdge: f.
                            default.browser.isChrome || f.
                            default.browser.isEdge,
                            meetingid: O.
                            default.localSharingPara.meetingid,
                            meetingnumb: O.
                            default.localSharingPara.meetingnumb,
                        ...
                        default.isSharingEncodePostStart = !0
                    } else O.
                    default.isSharingEncodePostStart || setTimeout(B, 100)
                }
            }
                ...
                try {
                    ! function() {
                        if (t.status === c.Sharing_Data)(function(e) {
                            try {
                                var t = e.ssrcFromPDU;
                                return null == t || (4294966272 & O.
                                    default.localSharingPara.userid) != (4294966272 & t)
                            } catch (e) {
                                return !0
                            }
                        })(t.data) && re(t.data);
                        else if (t.status === c.Sharing_Width_And_Height_Info) A.
                        default.publish(c.SHARING_PARAM_INFO_FROM_SOCKET, {
                            body: {
                                width: t.logicWidth,
                        ...
                        default.Notify_APPUI(c.SHARING_PARA, {
                            body: {
                                width: t.logicWidth,
                                height: t.logicHeight,
                                logicWidth: t.logicWidth,
                        ...
                        else if (t.status === c.SHARING_RENDER_MONITOR_LOG) I.
                        default.add_monitor2(t.data);
                        else if (t.status === c.SHARING_DATA_VIDEO_MODE)! function(e, t, n, i, r, a, o, u, s, d, c, l) {
                            if (!O.
                                default.isSharingPlayWork) return;
                            var f = {
                                yuvdata: t,
                                ntptime: n,
                                ssrc: e,
                            ...
                            O.
                            default.mediaSDKHandle.SharingRenderObj.Get_Sharing_Data_From_Queue(f)
                            ...
                            O.
                            default.mediaSDKHandle.SharingRenderObj.Get_Mouse_Data_From_Queue(c)
                        }(t.mouse_ssrc, t.data, t.mouse_timestamp, t.mouse_width, t.mouse_height, t.mouse_x, t.mouse_y, t.mLogic_w, t.mLogic_h, t.sync_id);
                        else if (t.status === c.SHARING_DECODE_MESSAGE) O.
                        default.Notify_APPUI(c.SHARING_DECODE_MAX_SIZE, {
                            ssrc: t.ssrc,
                            size: t.size
                        });
                        else if (t.status === c.Sharing_Dec_WASM_OK) I.
                        default.add_monitor("SDWS"), O.
                        default.isSharingDecodeWASMOK = !0, O.
                        default.sharingDecInitInstance.setWasmSuccess();
                        else if (t.status === c.Sharing_Dec_WASM_FAILED) I.
                        default.add_monitor("SDWF"), O.
                        default.isInitialFailed || (O.
                            default.Notify_APPUI && O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), p.SharingInit.publishSharingDecodeFailedEvent();
                        else if (t.status === c.Sharing_Handle_OK) I.
                        default.add_monitor("SDHS"), O.
                        default.sharingDecInitInstance.setHanderSuccess();
                        else if (t.status === c.Sharing_Handle_FAILED) I.
                        default.add_monitor("SHHF"), O.
                        default.isInitialFailed || (O.
                            default.Notify_APPUI && O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), p.SharingInit.publishSharingDecodeFailedEvent();
                        else if (t.status === c.Sharing_Dec_WebSocket_OK) I.
                        default.add_monitor("SDSS"), O.
                        default.sharingDecInitInstance.setSocketSuccess();
                        else if (t.status === c.Sharing_Dec_WebSocket_FAILED) I.
                        default.add_monitor("SDSF"), O.
                        default.isInitialFailed || (O.
                            default.sharingDecInitInstance.isSocketInitSuccess() ? O.
                            default.Notify_APPUI_SAFE(c.VIDEO_WEBSOCKET_BROKEN, null) : (O.
                                default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.
                                default.isInitialFailed = !0)), p.SharingInit.publishSharingDecodeFailedEvent();
                        else if (t.status == c.MONITOR_MESSAGE) O.
                        default.monitorDecodeSharing = t;
                        else if (t.status === c.DOWNLOAD_WASM_FROM_MAIN_THREAD) {
                            var e = O.
                            default.localSharingDecMGR.map.get(O.
                                default.SPECIAL_ID);
                            J(t.url, e)
                        } else t.status == c.APP_TROUBLESHOOTING_INFO ? (O.
                            default.monitorSharingDecodeAPPInfo = t, O.
                            default.Notify_APPUI(c.MONITOR_LOG, {
                                evt: 4167,
                                seq: 1,
                                body: {
                                    data: O.
                                    default.monitorSharingDecodeAPPInfo.data
                                }
                            }), O.
                            default.monitorSharingDecodeAPPInfo = null) : t.status == c.WCL_TROUBLESHOOTING_INFO && I.
                        default.add_monitor("SD" + t.data)
                    }()
                } catch (e) {
                    g.error(e)
                }
                O.
                default.sharingDecInitInstance.checkInitSuccess() && p.SharingInit.publishSharingDecodeSuccessEvent()
            }
            ...
            function Q(e) {
                ...
                try {
                    ! function() {
                        ...
                        else if (t.status === c.SHARING_GET_IMAGE_DATA_WRONG) I.
                        default.add_monitor("GIDF");
                        else if (t.status === c.Sharing_Dec_WASM_OK) I.
                        default.add_monitor("SEWS"), O.
                        default.isSharingEncodeWASMOK = !0, O.
                        default.sharingEncInitInstance.setWasmSuccess();
                        else if (t.status === c.Sharing_Dec_WASM_FAILED) I.
                        default.add_monitor("SEWF"), O.
                        default.isInitialFailed || (O.
                            default.Notify_APPUI && O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), p.SharingInit.publishSharingEncodeFailedEvent();
                        else if (t.status === c.Sharing_Handle_OK) I.
                        default.add_monitor("SEHS"), O.
                        default.sharingEncInitInstance.setHanderSuccess();
                        else if (t.status === c.Sharing_Handle_FAILED) I.
                        default.add_monitor("SEHF"), O.
                        default.isInitialFailed || (O.
                            default.Notify_APPUI && O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), p.SharingInit.publishSharingEncodeFailedEvent();
                        else if (t.status === c.Sharing_Dec_WebSocket_OK) I.
                        default.add_monitor("SESS"), O.
                        default.sharingEncInitInstance.setSocketSuccess();
                        else if (t.status === c.Sharing_Dec_WebSocket_FAILED) I.
                        default.add_monitor("SEWF"), O.
                        default.isInitialFailed || (O.
                            default.sharingEncInitInstance.isSocketInitSuccess() ? O.
                            default.Notify_APPUI_SAFE(c.VIDEO_WEBSOCKET_BROKEN, null) : (O.
                                default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.
                                default.isInitialFailed = !0)), p.SharingInit.publishSharingEncodeFailedEvent();
                        else if (t.status == c.Video_Capture_Tick) O.
                        default.mediaSDKHandle.Process_Sharing();
                        else if (t.status == c.MONITOR_MESSAGE) O.
                        default.monitorEncodeSharing = t;
                        else if (t.status == c.DOWNLOAD_WASM_FROM_MAIN_THREAD) {
                            var e = O.
                            default.localSharingEncMGR.map.get(O.
                                default.SPECIAL_ID);
                            J(t.url, e)
                        } else t.status == c.APP_TROUBLESHOOTING_INFO ? (O.
                            default.monitorSharingEncodeAPPInfo = t, O.
                            default.Notify_APPUI(c.MONITOR_LOG, {
                                evt: 4167,
                                seq: 1,
                                body: {
                            ...
                            default.monitorSharingEncodeAPPInfo = null) : t.status == c.WCL_TROUBLESHOOTING_INFO && I.
                        default.add_monitor("SE" + t.data)
                    }()
                } catch (e) {
                    g.error(e)
                }
                O.
                default.sharingEncInitInstance.checkInitSuccess() && p.SharingInit.publishSharingEncodeSuccessEvent()
            }
            ...
            function Y(e) {
                ...
                try {
                    ! function() {
                        ...
                        else if (t.status === c.VIDEO_RESOLUTION_UPDATE) O.
                        default.Notify_APPUI(c.CURRENT_VIDEO_RESOLUTION, {
                            width: t.width,
                            height: t.height
                        });
                        else if (t.status === c.VIDEO_RENDER_MONITOR_LOG) I.
                        default.add_monitor2(t.data);
                        else if (t.status === c.VIDEO_DROP_RATIO_FROM_WCL) {
                            var e = t.data;
                            A.
                            default.triggerSync(c.VIDEO_DATA_FROM_WORKER, e)
                        } else if (0 === t.status)! function(e, t, n, i, r, a, o, u, s, d, c) {
                            if (!O.
                                default.isVideoPlayWork) return;
                            var l = {
                                yuvdata: t,
                                ntptime: n,
                                ssrc: e,
                            ...
                            O.
                            default.mediaSDKHandle.VideoRenderObj.Get_Video_Data_From_Queue(l)
                        ...
                        else if (t.status === c.Video_Dec_WASM_OK) I.
                        default.add_monitor("VDWS"), O.
                        default.isVideoDecodeWASMOK = !0, O.
                        default.videoDecInitInstance.setWasmSuccess();
                        else if (t.status === c.DECODE_MESSAGE) O.
                        default.Notify_APPUI(c.VIDEO_DECODE_MAX_SIZE, {
                            ssrc: t.ssrc,
                            size: t.size
                        });
                        else if (t.status === c.Video_Dec_WASM_FAILED) I.
                        default.add_monitor("VDWF"), O.
                        default.isInitialFailed || (O.
                            default.Notify_APPUI && O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), _.VideoInit.publishDecodeInitFAILEDEvent();
                        else if (t.status === c.Video_Dec_Handle_OK) I.
                        default.add_monitor("VDHS"), O.
                        default.videoDecInitInstance.setHanderSuccess();
                        else if (t.status === c.Video_Dec_Handle_FAILED) I.
                        default.add_monitor("VDHF"), O.
                        default.isInitialFailed || (O.
                            default.Notify_APPUI && O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), _.VideoInit.publishDecodeInitFAILEDEvent();
                        else if (t.status === c.Video_Dec_WebSocket_OK) I.
                        default.add_monitor("VDSS"), O.
                        default.videoDecInitInstance.setSocketSuccess();
                        else if (t.status === c.Video_Dec_WebSocket_FAILED) I.
                        default.add_monitor("VDSF"), O.
                        default.isInitialFailed || (O.
                            default.videoDecInitInstance.isSocketInitSuccess() ? O.
                            default.Notify_APPUI_SAFE(c.VIDEO_WEBSOCKET_BROKEN, null) : (O.
                                default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.
                                default.isInitialFailed = !0)), _.VideoInit.publishDecodeInitFAILEDEvent();
                        else if (t.status == c.MONITOR_MESSAGE) O.
                        default.monitorDecodeVideo = t;
                        else if (t.status == c.APP_TROUBLESHOOTING_INFO) O.
                        default.monitorVideoDecodeAPPInfo = t, O.
                        default.Notify_APPUI(c.MONITOR_LOG, {
                            evt: 4167,
                            seq: 1,
                            body: {
                        ...
                        default.monitorVideoDecodeAPPInfo = null;
                        else if (t.status == c.DOWNLOAD_WASM_FROM_MAIN_THREAD) {
                            var n = O.
                            default.localVideoDecMGR.map.get(O.
                                default.SPECIAL_ID);
                            J(t.url, n)
                        } else t.status == c.WCL_TROUBLESHOOTING_INFO && I.
                        default.add_monitor("VD" + t.data)
                    }()
                } catch (e) {
                    g.error(e)
                }
                O.
                default.videoDecInitInstance.checkInitSuccess() && _.VideoInit.publishDecodeInitSuccessEvent()
            }
            ...
            function X(e) {
                ...
                try {
                    ! function() {
                        ...
                        else if (t.status === c.Video_Enc_WASM_OK || t.status === c.Video_Dec_WASM_OK) I.
                        default.add_monitor("VEWS"), ce(0, null), O.
                        default.isVideoEncodeWASMOK = !0, O.
                        default.videoInitInstance.setWasmSuccess();
                        else if (t.status === c.Video_Enc_WASM_FAILED) I.
                        default.add_monitor("VEWF"), O.
                        default.isInitialFailed || (O.
                            default.Notify_APPUI && O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), _.VideoInit.publishEncodeInitFAILEDEvent();
                        else if (t.status === c.Video_Enc_Handle_OK || c.Video_Dec_Handle_OK === t.status) I.
                        default.add_monitor("VEHS"), O.
                        default.videoInitInstance.setHanderSuccess();
                        else if (t.status === c.Video_Enc_Handle_FAILED || c.Video_Dec_Handle_FAILED === t.status) I.
                        default.add_monitor("VEHF"), O.
                        default.isInitialFailed || (O.
                            default.Notify_APPUI && O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), _.VideoInit.publishEncodeInitFAILEDEvent();
                        else if (t.status === c.Video_Enc_WebSocket_OK || c.Video_Dec_WebSocket_OK === t.status) I.
                        default.add_monitor("VESS"), O.
                        default.videoInitInstance.setSocketSuccess();
                        else if (t.status === c.Video_Enc_WebSocket_FAILED || t.status === c.Video_Dec_WebSocket_FAILED) I.
                        default.add_monitor("VESF"), O.
                        default.isInitialFailed || (O.
                            default.videoInitInstance.isSocketInitSuccess() ? O.
                            default.Notify_APPUI_SAFE(c.VIDEO_WEBSOCKET_BROKEN, null) : (O.
                                default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.
                                default.isInitialFailed = !0)), _.VideoInit.publishEncodeInitFAILEDEvent(), A.
                        default.trigger(_.VideoInit.publishEncodeInitFAILEDEvent());
                        else if (t.status === c.Video_Capture_Tick) O.
                        default.mediaSDKHandle.Process_Video();
                        else if (t.status == c.MONITOR_MESSAGE) O.
                        default.monitorEncodeVideo = t;
                        else if (t.status == c.APP_TROUBLESHOOTING_INFO) O.
                        default.monitorVideoEncodeAPPInfo = t, O.
                        default.Notify_APPUI(c.MONITOR_LOG, {
                            evt: 4167,
                            seq: 1,
                            body: {
                        ...
                        default.monitorVideoEncodeAPPInfo = null;
                            ...
                            var n = O.
                            default.localVideoEncMGR.map.get(O.
                                default.SPECIAL_ID);
                            J(t.url, n)
                        } else t.status == c.WCL_TROUBLESHOOTING_INFO && I.
                        default.add_monitor("VE" + t.data)
                    }()
                } catch (e) {
                    g.error(e)
                }
                O.
                default.videoInitInstance.checkInitSuccess() && _.VideoInit.publishEncodeInitSuccessEvent()
            }

            function J(e, t) {
                f.
                default.downloadBinary(e).then(function(e) {
                    t.postMessage({
                ...
                try {
                    ! function() {
                        if (0 === t.status) {
                            if (t.time ? O.
                                default.AudioNode ? O.
                                default.AudioNode.postData("data", {
                                    ssrc: O.
                                    default.CurrentSSRC,
                                    data: t.data,
                                    time: t.time
                                }) : ae(n, t.data, t.time) : O.
                                default.AudioNode ? O.
                                default.AudioNode.postData("data", {
                                    ssrc: O.
                                    default.CurrentSSRC,
                        ...
                        } else if (t.status === c.Audio_Enc_WASM_OK || t.status === c.Audio_Dec_WASM_OK) I.
                        default.add_monitor("ADWS"), O.
                        default.isAudioDecodeWASMOK = !0, O.
                        default.audioDecInitInstance.setWasmSuccess();
                        else if (t.status === c.Audio_Dec_WASM_FAILED) I.
                        default.add_monitor("ADWF"), O.
                        default.isInitialFailed || O.
                        default.Notify_APPUI && (O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), E.AudioInit.publishAudioDecodeFAILEDEvent();
                        else if (t.status === c.Audio_Dec_Handle_OK) I.
                        default.add_monitor("ADHS"), O.
                        default.audioDecInitInstance.setHanderSuccess();
                        else if (t.status === c.Audio_Dec_Handle_FAILED) I.
                        default.add_monitor("ADHF"), O.
                        default.isInitialFailed || O.
                        default.Notify_APPUI && (O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), E.AudioInit.publishAudioDecodeFAILEDEvent();
                        else if (t.status === c.Audio_Dec_WebSocket_OK) I.
                        default.add_monitor("ADSS"), O.
                        default.audioDecInitInstance.setSocketSuccess();
                        else if (t.status === c.Audio_Dec_WebSocket_FAILED) I.
                        default.add_monitor("ADSF"), O.
                        default.isInitialFailed || (O.
                            default.audioDecInitInstance.isSocketInitSuccess() ? O.
                            default.Notify_APPUI_SAFE(c.AUDIO_WEBSOCKET_BROKEN, null) : (O.
                                default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.
                                default.isInitialFailed = !0)), E.AudioInit.publishAudioDecodeFAILEDEvent();
                        else if (6 === t.status);
                        else if (-6 === t.status) O.
                        default.isInitialFailed || O.
                        default.Notify_APPUI && (O.
                            default.Notify_APPUI(c.INIT_FAILED, null), O.
                            default.isInitialFailed = !0), E.AudioInit.publishAudioDecodeFAILEDEvent();
                        else if (t.status == c.MONITOR_MESSAGE) O.
                        default.monitorDecodeAudio = t;
                        else if (t.status === c.DOWNLOAD_WASM_FROM_MAIN_THREAD) {
                            var r = O.
                            default.localAudioDecMGR.map.get(O.
                                default.SPECIAL_ID);
                        ...
                        default.add_monitor("AD" + t.data): t.status == c.CURRENT_SSRC_TIME && (O.
                            default.CurrentSSRCTime = t.data)
                    }()
                } catch (e) {
                    g.error(e)
                }
                O.
                default.audioDecInitInstance.checkInitSuccess() && E.AudioInit.publishAudioDecodeSuccessEvent()
            }
            ...
            function z(e) {
                if (O.
                    ...
                    try {
                        ! function() {
                            var t = O.
                            default.SPECIAL_ID, n = e.data, i = O.
                            default.localAudioDecMGR.map.get(t);
                            if (0 == n.status) i && i.postMessage({
                                command: "EncodedAudioFrame",
                                data: n.data
                            }, [n.data.buffer]);
                            else if (n.status == c.AUDIO_ENCODED_DATA) A.
                            default.triggerSync(c.AUDIO_DATA_FROM_WORKER, n.data);
                            else if (n.status === c.Audio_Enc_WASM_OK || n.status === c.Audio_Dec_WASM_OK) I.
                            default.add_monitor("AEWS"), _e(0, null), O.
                            default.isAudioEncodeWASMOK = !0, O.
                            default.audioEncodeInitInstance.setWasmSuccess();
                            else if (n.status === c.Audio_Enc_WASM_FAILED || n.status === c.Audio_Dec_WASM_FAILED) I.
                            default.add_monitor("AEWF"), O.
                            default.isInitialFailed || O.
                            default.Notify_APPUI && (O.
                                default.Notify_APPUI(c.INIT_FAILED, null), O.
                                default.isInitialFailed = !0), E.AudioInit.publishAudioEncodeFAILEDEvent();
                            else if (n.status === c.Audio_Dec_Handle_OK) I.
                            default.add_monitor("AEHS"), O.
                            default.audioEncodeInitInstance.setHanderSuccess();
                            else if (n.status === c.Audio_Dec_WebSocket_OK) I.
                            default.add_monitor("AESS"), O.
                            default.audioEncodeInitInstance.setSocketSuccess();
                            else if (n.status === c.Audio_Dec_WebSocket_FAILED) I.
                            default.add_monitor("AESF"), O.
                            default.isInitialFailed || (O.
                                default.audioEncodeInitInstance.isSocketInitSuccess() ? O.
                                default.Notify_APPUI_SAFE(c.AUDIO_WEBSOCKET_BROKEN, null) : (O.
                                    default.Notify_APPUI_SAFE(c.INIT_FAILED, null), O.
                                    default.isInitialFailed = !0)), E.AudioInit.publishAudioEncodeFAILEDEvent();
                            else if (n.status === c.Audio_Enc_Handle_FAILED || n.status === c.Audio_Dec_Handle_FAILED) I.
                            default.add_monitor("AEHF"), O.
                            default.isInitialFailed || O.
                            default.Notify_APPUI && (O.
                                default.Notify_APPUI(c.INIT_FAILED, null), O.
                                default.isInitialFailed = !0), E.AudioInit.publishAudioEncodeFAILEDEvent();
                            else if (n.status === c.Audio_Mute) O.
                            default.Notify_APPUI && O.
                            default.Notify_APPUI(c.AUDIO_ZERO_DATA, null);
                            else if (n.status === c.AUDIO_DELAY) O.
                            default.indexDbObject.put(n.delay, "delay"), O.
                            default.openIndexFlag && O.
                            default.indexDbObject.select("delay");
                            else if (n.status === c.DOWNLOAD_WASM_FROM_MAIN_THREAD) {
                                var r = O.
                                default.localAudioEncMGR.map.get(O.
                                    default.SPECIAL_ID);
                                J(n.url, r)
                            } else n.status == c.WCL_TROUBLESHOOTING_INFO ? I.
                            default.add_monitor("AE" + n.data): (n.status, c.AUDIO_CLIPPING)
                        }()
                    } catch (e) {
                        g.error(e)
                    }
                    O.
                    default.audioEncodeInitInstance.checkInitSuccess() && E.AudioInit.publishAudioEncodeSuccessEvent()
                }
            }

            function Z(e, t) {
                if (e && e.isDestroy) return g("WorkerType:sharingEnc;The relative SDK instance is destroy, don't start relative worker, avoid multiple same workers. ");
                if (O.
                    default.localSharingEncMGR)
                    if (O.
                        default.isSharingEncodeThreadStart) setTimeout(B, 100);
                    else {
                        if (O.
                            default.isSharingEncodeThreadStart = !0, "" == O.
                            default.sharingEncWorkerPath) return void console.error("Worker Path Error!");
                        R(t, O.
                            default.localSharingEncMGR, Q, D.WORKER_TYPE.SHARING_ENCODE, e)
                    }
            }

            function $(e, t) {
                if (e && e.isDestroy) return g("WorkerType:sharingDec;The relative SDK instance is destroy, don't start relative worker, avoid multiple same workers. ");
                if (O.
                    default.localSharingDecMGR)
                    if (O.
                        default.isSharingDecodeThreadStart) setTimeout(K, 100);
                    else {
                        if (O.
                            default.isSharingDecodeThreadStart = !0, "" == O.
                            default.sharingDecWorkerPath) return void console.error("Worker Path Error!");
                        R(t, O.
                            default.localSharingDecMGR, j, D.WORKER_TYPE.SHARING_DECODE, e)
                    }
            }
            var ee = (0, S.
                default)(function() {
                try {
                    O.
                    default.sharedBuffer = new SharedArrayBuffer(480 * O.
                        default.shareBufferSampleNumb * Int32Array.BYTES_PER_ELEMENT + 12 * O.
                        default.shareBufferSampleNumb);
                    var e = new Int32Array(O.
                        default.sharedBuffer);
                    v.Lock.initialize(e, 0)
                } catch (e) {
                    O.
                    default.sharedBuffer = null
                }
            });
                            ...
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    if (ee(), O.
                                        ...
                                        default.localAudioEncMGR || (O.
                                            default.localAudioEncMGR = new l.AudioMGR), O.
                                        default.audioDecWorkerPath = t.audioDecWorkerPath, O.
                                        default.audioEncWorkerPath = t.audioEncWorkerPath, t.audioDecWorkerPath !== t.audioEncWorkerPath) {
                                        e.next = 13;
                                        break
                                    }
                                ...
                                case 8:
                                    n = e.sent, O.
                                default.audioEncodeResponse = n, O.
                                default.audioDecodeResponse = n, e.next = 15;
                                break;
                                case 13:
                                    return e.next = 15, u.
                                default.all([C(t.audioEncWorkerPath), C(t.audioDecWorkerPath)]).then(function(e) {
                                    O.
                                    default.audioEncodeResponse = e[0], O.
                                    default.audioDecodeResponse = e[1]
                                });
                                case 15:
                                    Se(0);
                                case 16:
            ...
            function ne(e) {
                O.
                default.Audio_WebSocket_Ip_Address || (O.
                    default.Audio_WebSocket_Ip_Address = e)
            }

            function ie(e) {
                O.
                default.Sharing_WebSocket_Ip_Address || (O.
                    default.Sharing_WebSocket_Ip_Address = e)
            }

            function re(e) {
                O.
                default.localSharingDecMGR && ("sharingPara" == e.type && (I.
                        default.add_monitor("SHPA"), A.
                        default.publish(c.SHARING_PARAM_INFO_FROM_SOCKET, e.data), O.
                        default.Notify_APPUI(c.SHARING_PARA, e.data)), O.
                    default.isSharingPlayWork && O.
                    default.localSharingDecMGR.PutData(e))
            }

            function ae(e, t, n) {
                if (e = O.
                    default.SPECIAL_ID, O.
                    default.isAudioPlayWork && O.
                    default.localAudioDecMGR) {
                    var i = O.
                    default.localAudioDecMGR.AudioQueueMGR.GetQueue(e);
                    if (i || (i = O.
                        default.localAudioDecMGR.AudioQueueMGR.AddQueue(e)), n) {
                        var r = new a.
                        default, o = n.length / 12, u = 0, s = 0;
                        for (u = 0; u < o; u++) {
                            e = 0;
                            for (s = 12 * u + 0; s < 12 * u + 4; s++) e += n[s] * Math.pow(256, s - 12 * u);
                            e >>= 10;
                            var d = 0;
                    ...
                    var l = oe(e);
                    if (l > O.
                        default.audioBufferSize + 2 && g("the length is " + l), l > 50)
                        for (var f = l - O.
                            default.audioBufferSize; f >= 0;) se(e), f--;
                    else if (l > O.
                        default.audioBufferSize) {
                        var h = O.
                        default.localAudioDecMGR.map.get(O.
                            default.SPECIAL_ID);
                        h && h.postMessage({
            ...
            function oe(e) {
                ...
                default.SPECIAL_ID, O.
                default.localAudioDecMGR ? O.
                default.localAudioDecMGR.AudioQueueMGR.GetQueueLength(e) : 0
            }

            function ue(e) {
                O.
                default.localAudioDecMGR && O.
                default.localAudioDecMGR.UpdateSSRCTimeMap(e)
            }
            ...
            function de() {
                if (O.
                    ...
                    default.localVideoDecMGR.map.get(O.
                        default.SPECIAL_ID);
                    e && O.
                    default.isVideoDecodeWASMOK && !O.
                    default.isVideoDecodePostStart && O.
                    default.localVideoPara ? (e.postMessage({
                            command: "startMedia",
                            websocket_ip_address: O.
                            default.Video_WebSocket_Ip_Address + "&mode=5",
                            confId: O.
                            default.localVideoPara.confId,
                            confKey: "",
                            logon: O.
                            default.localVideoPara.logon,
                            mtu_size: 0,
                            meetingid: O.
                            default.localVideoPara.meetingid,
                            meetingnumb: O.
                            default.localVideoPara.meetingnumb,
                            multiThreadNum: 1
                        }), O.
                        default.isVideoDecodePostStart = !0) : O.
                    default.isVideoDecodePostStart || setTimeout(de, 100)
                }
            }

            function ce(e, t, n, i) {
                if (n && n.isDestroy) return g("WorkerType:videoDec;The relative SDK instance is destroy, don't start relative worker, avoid multiple same workers. ");
                if (O.
                    default.SPECIAL_ID, O.
                    default.localVideoDecMGR)
                    if (O.
                        default.isVideoDecodeThreadStart) setTimeout(de, 100);
                    else {
                        if (O.
                            default.isVideoDecodeThreadStart = !0, "" == O.
                            default.videoDecWorkerPath) return void console.error("Worker Path Error!");
                        R(i, O.
                            default.localVideoDecMGR, Y, D.WORKER_TYPE.VIDEO_DECODE, n)
                    }
            }
            ...
            function le() {
                if (O.
                    ...
                    default.localVideoEncMGR.map.get(O.
                        default.SPECIAL_ID);
                    if (e && O.
                        default.isVideoEncodeWASMOK && !O.
                        default.isVideoEncodePostStart && O.
                        default.localVideoPara) {
                        var t = 0;
                        t = "firefox" === f.
                        default.browserType.browser ? 1080 : 1070, O.
                        default.mediaSDKHandle.mtu_size = t;
                        var n = null;
                        O.
                        default.ivObj && (n = O.
                            default.ivObj[D.WORKER_TYPE.VIDEO_ENCODE], n = f.
                            default.stringSplitByComma2Buffer(n)), e.postMessage({
                            command: "startMedia",
                            websocket_ip_address: O.
                            default.Video_WebSocket_Ip_Address + "&mode=2",
                            confId: O.
                            default.localVideoPara.confId,
                            confKey: "",
                            logon: O.
                            ...
                            sendvideo: !0,
                            isChromeOrEdge: f.
                            default.browser.isEdge || f.
                            default.browser.isChrome,
                            mtu_size: t,
                            meetingid: O.
                            default.localVideoPara.meetingid,
                            meetingnumb: O.
                        ...
                        default.isVideoEncodePostStart = !0
                    } else O.
                    default.isVideoEncodePostStart || setTimeout(le, 100)
                }
            }

            function fe(e, t, n, i) {
                if (n && n.isDestroy) return g("WorkerType:videoEnc;The relative SDK instance is destroy, don't start relative worker, avoid multiple same workers. ");
                O.
                default.SPECIAL_ID, O.
                default.localVideoEncMGR && (O.
                    default.isVideoEncodeThreadStart || (O.
                        default.isVideoEncodeThreadStart = !0, R(i, O.
                            default.localVideoEncMGR, X, D.WORKER_TYPE.VIDEO_ENCODE, n)))
            }
            ...
            function he() {
                if (O.
                    ...
                    default.localAudioDecMGR.map.get(O.
                        default.SPECIAL_ID);
                    if (O.
                        default.localAudioPara && e && O.
                        default.isAudioDecodeWASMOK && !O.
                        default.isAudioDecodePostStart) {
                        if (e.postMessage({
                                command: "startMedia",
                                websocket_ip_address: O.
                                default.Audio_WebSocket_Ip_Address + "&mode=5",
                                sampleRate: O.
                                default.localAudioPara.sampleRate,
                                userid: O.
                                default.localAudioPara.userid,
                                logon: O.
                                default.localAudioPara.logon,
                                isEdge: f.
                                default.browser.isEdge,
                                decode: 1,
                                meetingid: O.
                                default.localAudioPara.meetingid,
                                meetingnumb: O.
                                default.localAudioPara.meetingnumb
                            }), O.
                            default.sharedBuffer) try {
                            e.postMessage({
                        ...
                        O.
                        default.isAudioDecodePostStart = !0
                    } else O.
                    default.isAudioDecodePostStart || setTimeout(he, 100)
                }
            }

            function _e(e, t, n, i) {
                if (n && n.isDestroy) return g("WorkerType:audioDec;The relative SDK instance is destroy, don't start relative worker, avoid multiple same workers. ");
                O.
                default.SPECIAL_ID, O.
                default.localAudioDecMGR && (O.
                    default.isAudioDecodeThreadStart || (O.
                        default.isAudioDecodeThreadStart = !0, R(i, O.
                            default.localAudioDecMGR, q, D.WORKER_TYPE.AUDIO_DECODE, n)))
            }
            ...
            function Ee(e) {
                if (e >>= 10, O.
                    default.localAudioDecMGR) {
                    var t = O.
                    default.localAudioDecMGR.GetSSRCTimeMap(e);
                    return null === t ? 0 : t
                }
            }
            ...
            function pe() {
                ...
                if (O.
                    default.localAudioPara && e && O.
                    default.isAudioEncodeWASMOK && !O.
                    default.isAudioEncodePostStart) {
                    var t = null;
                    if (O.
                        default.ivObj && (t = O.
                            default.ivObj[D.WORKER_TYPE.AUDIO_ENCODE], t = f.
                            default.stringSplitByComma2Buffer(t)), e.postMessage({
                            command: "startMedia",
                            websocket_ip_address: O.
                            default.Audio_WebSocket_Ip_Address + "&mode=2",
                            sampleRate: O.
                            default.localAudioPara.sampleRate,
                            userid: O.
                            default.localAudioPara.userid,
                    ...
                    O.
                    default.isAudioEncodePostStart = !0
                } else setTimeout(pe, 100)
            }

            function Se(e, t, n) {
                if (t && t.isDestroy) return g("WorkerType:audioEnc;The relative SDK instance is destroy, don't start relative worker, avoid multiple same workers. ");
                O.
                default.SPECIAL_ID, O.
                default.isAudioEncodeThreadStart || (O.
                    default.isAudioEncodeThreadStart = !0, R(n, O.
                        default.localAudioEncMGR, z, D.WORKER_TYPE.AUDIO_ENCODE, t))
            }
                ...
                try {
                    if (I.
                        ...
                        var t = ["ERR:", e.message, "f"].join(""),
                            n = I.
                        default.checkIsNecessaryExceptionLogAndReturnRepeatTimes(t);
                        n.isNecessary ? (g("error repeat ".concat(n.repeatNumber), t), I.
                            default.add_monitor(t + "(repeat:".concat(n.repeatNumber, ")"))) : g("error but ignore", e.message)
                    }
                } catch (e) {
            ...
            function De(e) {
                ...
                default (function(t, n) {
                    var i = 500,
                        ...
                        a = 0;
                    ! function o() {
                        if (++a >= r) return n("Timeout. wait for worker ".concat(e, " to be ready."));
                        ve(e) ? t(ve(e)) : setTimeout(o, i)
                    }()
                })
            }
            ...
            function ve(e) {
                var t = new a.
                default;
                t.set(D.WORKER_TYPE.AUDIO_DECODE, O.
                    default.localAudioDecMGR), t.set(D.WORKER_TYPE.AUDIO_ENCODE, O.
                    default.localAudioEncMGR), t.set(D.WORKER_TYPE.VIDEO_DECODE, O.
                    default.localVideoDecMGR), t.set(D.WORKER_TYPE.VIDEO_ENCODE, O.
                    default.localVideoEncMGR), t.set(D.WORKER_TYPE.SHARING_DECODE, O.
                    default.localSharingDecMGR), t.set(D.WORKER_TYPE.SHARING_ENCODE, O.
                    default.localSharingEncMGR);
                var n = O.
                default.SPECIAL_ID, i = t.get(e);
            ...
            function ge() {
                return (ge = (0, d.
                    default)(s.
                    default.mark(function e(t, n) {
                        var i, r, a, o, u = arguments;
                        return s.
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    if (i = u.length > 2 && void 0 !== u[2] ? u[2] : "PUSH_MESSAGE_FROM_MAIN_TO_WORKER", r = u.length > 3 && void 0 !== u[3] && u[3], a = u.length > 4 && void 0 !== u[4] && u[4], e.prev = 3, o = ve(t)) {
                                        e.next = 15;
                                        break
                                    }
                                    if (a) {
                                    ...
                                    return g("worker handle not ready, drop!", t, n, i), e.abrupt("return");
                                case 11:
                                    return g.warn("worker handle not ready, waiting!", t, n, i), e.next = 14, De(t);
                                case 14:
                                    o = e.sent;
                                case 15:
                                    r ? o.postMessage({
                                ...
                                case 18:
                                    e.prev = 18, e.t0 = e.
                                    catch (3), g.warn("try to push message to workerType:".concat(t, ", but it does not exist. Command: ").concat(i, "; Message: ").concat(n)), g.warn(e.t0);
                                case 22:
                                case "end":
                                    return e.stop()
                            }
                                            ...
                                            default.mark(function e(t) {
                                                ...
                                                default.wrap(function(e) {
                                                    for (;;) switch (e.prev = e.next) {
                                                        ...
                                                        case 6:
                                                            return e.prev = 6, e.t0 = e.
                                                            catch (2), e.abrupt("return", !1);
                                                        case 9:
                                                        case "end":
                                                            return e.stop()
                                                    }
        ...
        function(e, t, n) {
            n(52), n(21), n(34), n(122), n(126), n(127), e.exports = n(0).Promise
        },
        function(e, t, n) {
            var i = n(53),
                r = n(47);
        ...
        function(e, t, n) {
            ...
            var i, r, a, o, u = n(29),
                ...
                P = !! function() {
                    try {
                        ...
                        return (T || "function" == typeof PromiseRejectionEvent) && e.then(M) instanceof t && 0 !== R.indexOf("6.6") && -1 === v.indexOf("Chrome/66")
                    } catch (e) {}
                }(),
                b = function(e) {
                    var t;
                        ...
                        A(function() {
                            for (var i = e._v, r = 1 == e._s, a = 0, o = function(t) {
                                    var n, a, o, u = r ? t.ok : t.fail,
                                        ...
                                        c = t.domain;
                                    try {
                                        u ? (r || (2 == e._h && U(e), e._h = 1), !0 === u ? n = i : (c && c.enter(), n = u(i), c && (c.exit(), o = !0)), n === t.promise ? d(g("Promise-chain cycle")) : (a = b(n)) ? a.call(n, s, d) : s(n)) : d(i)
                                    } catch (e) {
                                        c && !o && c.exit(), d(e)
                                    }
                                }; n.length > a;) o(n[a++]);
            ...
            P || (y = function(e) {
                ...
                try {
                    e(d(x, this, 1), d(V, this, 1))
                } catch (e) {
                    V.call(this, e)
                }
            }, (i = function(e) {
                this._c = [], this._a = void 0, this._s = 0, this._d = !1, this._v = void 0, this._h = 0, this._n = !1
            }).prototype = n(60)(y.prototype, {
                then: function(e, t) {
                    var n = N(p(this, y));
                ...
                var e = new i;
                this.promise = e, this.resolve = d(x, e, 1), this.reject = d(V, e, 1)
            }, I.f = N = function(e) {
        ...
        function(e, t) {
            ! function(t) {
                ...
                if (c) d && (e.exports = c);
                    ...
                    (c = t.regeneratorRuntime = d ? e.exports : {}).wrap = D;
                    ...
                    var I = m.prototype = O.prototype = Object.create(p);
                    g.prototype = I.constructor = m, m.constructor = g, m[s] = g.displayName = "GeneratorFunction", c.isGeneratorFunction = function(e) {
                ...
                function y(e, t) {
                    ...
                    if (i === n) {
                        if (t.delegate = null, "throw" === t.method) {
                            if (e.iterator.
                                return &&(t.method = "return", t.arg = n, y(e, t), "throw" === t.method)) return E;
                            t.method = "throw", t.arg = new TypeError("The iterator does not provide a 'throw' method")
                        }
                        return E
                    }
                    var r = v(i, e.iterator, t.arg);
        ...
        function(e, t, n) {
            n(21), n(34), e.exports = n(62).f("iterator")
        },
        function(e, t, n) {
            e.exports = n(138)
        },
        function(e, t, n) {
            n(139), n(52), n(142), n(143), e.exports = n(0).Symbol
        },
        function(e, t, n) {
            "use strict";
            var i = n(2),
                ...
                j = function(e) {
                    ...
                    return e === W && Y(G, t, n), A(e), t = v(t, !0), A(n), r(x, t) ? (n.enumerable ? (r(e, w) && e[w][t] && (e[w][t] = !1), n = g(n, {
                        enumerable: O(0, !1)
                    })) : (r(e, w) || M(e, w, O(1, {})), e[w][t] = !0), B(e, t, n)) : M(e, t, n)
                }, X = function(e, t) {
                    A(e);
                    for (var n, i = p(t = D(t)), r = 0, a = i.length; a > r;) Y(e, n = i[r++], t[n]);
                    return e
                }, J = function(e) {
                    var t = U.call(this, e = v(e, !0));
                    return !(this === W && r(x, e) && !r(G, e)) && (!(t || !r(this, e) || !r(x, e) || r(this, w) && this[w][e]) || t)
                }, q = function(e, t) {
                    if (e = D(e), t = v(t, !0), e !== W || !r(x, t) || r(G, t)) {
                        var n = T(e, t);
                        return !n || !r(x, t) || r(e, w) && e[w][t] || (n.enumerable = !0), n
                    }
                }, z = function(e) {
                    for (var t, n = N(D(e)), i = [], a = 0; n.length > a;) r(x, t = n[a++]) || t == w || t == s || i.push(t);
                    return i
                }, Z = function(e) {
                    for (var t, n = e === W, i = N(n ? G : D(e)), a = [], o = 0; i.length > o;)!r(x, t = i[o++]) || n && !r(W, t) || a.push(x[t]);
                    return a
                };
            F || (u((P = function() {
                ...
                var e = f(arguments.length > 0 ? arguments[0] : void 0),
                    t = function(n) {
                        this === W && t.call(G, n), r(this, w) && r(this[w], e) && (this[w][e] = !1), B(this, e, O(1, n))
                    };
                return a && K && B(W, e, {
                    configurable: !0,
                    set: t
                ...
                return this._k
            }), C.f = q, R.f = Y, n(92).f = m.f = z, n(37).f = J, n(61).f = Z, a && !n(29) && u(W, "propertyIsEnumerable", J, !0), _.f = function(e) {
                return j(h(e))
            }), o(o.G + o.W + o.F * !F, {
                Symbol: P
            });
        ...
        function(e, t, n) {
            n(52), n(21), n(34), n(145), n(151), n(154), n(156), e.exports = n(0).Map
        },
        function(e, t, n) {
            "use strict";
            var i = n(146),
        ...
        function(e, t, n) {
            ...
            e.exports = function(e, t, n, p, S, A) {
                var I = i[e],
                    ...
                    O = D && D.prototype,
                    g = {};
                return E && "function" == typeof D && (A || O.forEach && !o(function() {
                    (new D).entries().next()
                })) ? (D = t(function(t, n) {
                    c(t, D, e, "_c"), t._c = new I, null != n && d(n, S, t[v], t)
                }), _("add,clear,delete,forEach,get,has,set,keys,values,entries,toJSON".split(","), function(e) {
                    var t = "add" == e || "set" == e;
                    e in O && (!A || "clear" != e) && u(D.prototype, e, function(n, i) {
                        if (c(this, D, e), !t && A && !l(n)) return "get" == e && void 0;
                        var r = this._c[e](0 === n ? 0 : n, i);
                        return t ? this : r
                    })
                }), A || h(D.prototype, "size", {
                    get: function() {
                        return this._c.size
                    }
                })) : (D = p.getConstructor(t, e, S, v), s(D.prototype, n), a.NEED = !0), f(D, e), g[e] = D, r(r.G + r.W + r.F, g), A || p.setStrong(D, e, S), D
            }
        },
        function(e, t, n) {
            var i = n(10),
            ...
            e.exports = function(e, t) {
                ...
                return function(t, u, _) {
                    for (var E, p, S = a(t), A = r(S), I = i(u, _, 3), D = o(A.length), v = 0, O = n ? h(t, D) : s ? h(t, 0) : void 0; D > v; v++)
                        if ((f || v in A) && (p = I(E = A[v], v, S), e))
                            if (n) O[v] = p;
                            else if (p) switch (e) {
                        case 3:
                            return !0;
        ...
        function(e, t, n) {
            ...
            e.exports = {
                set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, i) {
                    try {
                        (i = n(10)(Function.call, n(48).f(Object.prototype, "__proto__").set, 2))(e, []), t = !(e instanceof Array)
                    } catch (e) {
                        t = !0
                    }
                    return function(e, n) {
                ...
                ! function(n, i) {
                    ...
                    ! function(e) {
                        ...
                        function u(e, n, r, a) {
                            ...
                            return !!s && (!0 === r ? u() : setTimeout(u, 0), !0)
                        }
        ...
        function(e, t, n) {
            ...
            var r = i(n(24)),
                ...
                u = function() {
                    function e(t, n) {
                        if ((0, r.
                            default)(this, e), !(t instanceof Int32Array && n | 0 === n && n >= 0 && n + o <= t.length)) throw new Error("Bad arguments to Lock constructor: ".concat(t, " ").concat(n));
        ...
        function(e, t, n) {
            ...
            (function(e) {
                ...
                function k(e) {
                    ...
                    this.keyMouseEventHandler = function(e) {
                    ...
                    }, this.keyMouseEventHandlerThrottle = (0, p.
                        default)(function(e) {
                        ...
                        x2video: 0,
                        y2video: 0
                    }, this.isControllerNow = !0, this.remoteOS = g.OS_ENUM.UNKNOWN, this.localOS = this.getLocalOS(), this._blockedCopyKeyboardList = []
                }
                k.prototype = {
                    start: function() {
                        var e = this;
                    ...
                    destroy: function() {
                        ...
                        default (function(t, n) {
                            try {
                                m("destroy remote control"), e.unbindEvent(), e.uncheckAndClearKeydownupMergeRemoveMap(), e.destroySocket(), A.
                                default.unsubscribe(e.PUBSUB_SHARING_PARAM_INFO_TOKEN), t(!0)
                            } catch (e) {
                                m(e), t(!1)
                            }
                        })
                    ...
                    getLocalOS: function() {
                        ...
                        return /win/i.test(t) ? g.OS_ENUM.WIN : /mac/i.test(t) ? g.OS_ENUM.MAC : g.OS_ENUM.UNKNOWN
                    },
                        ...
                        default.mark(function e(t) {
                            ...
                            default.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 2:
                                        if (n = this._blockedCopyKeyboardList, "done" != n[n.length - 1]) {
                                            e.next = 8;
                                            break
                                        }
                                        return e.abrupt("return");
                                    ...
                                    case 0:
                                        if (this.isFocusNow()) {
                                            for (n = (t.clipboardData || window.clipboardData).getData("text"), m("_pasteOnDocument", n), i = [], r = 0; r < n.length; r++)
                                                for (a = n[r], o = v.
                                                    default.encode(a), u = 0; u < o.length; u++) i.push(o.charCodeAt(u));
                                            for (s = new ArrayBuffer(8 + i.length), d = new Uint8Array(s), c = new DataView(s, 4, 4), l = new Uint8Array(s, 8), d[0] = P, c.setUint32(0, i.length, !0), f = 0; f < i.length; f++) l[f] = i[f];
                    ...
                    subscribeSharingWidthOrHeightChange: function() {
                        var e = this;
                        this.PUBSUB_SHARING_PARAM_INFO_TOKEN = A.
                        default.on(I.SHARING_PARAM_INFO_FROM_SOCKET, function(t, n) {
                    ...
                    setSrcOffsetXY: function() {
                        ...
                        if (!(0, D.
                            default)(n) && !(0, D.
                            default)(i)) throw new Error("the value of source offset x or y is not correct");
                    ...
                    sendPostionPDU: function() {
                        var e = new ArrayBuffer(36),
                            ...
                            n = new DataView(e, 4),
                            i = new DataView(e, 20);
                        t[0] = T, n.setInt32(0, this.positionMap.src.x, !0), n.setInt32(4, this.positionMap.src.y, !0), n.setInt32(8, this.positionMap.src.w, !0), n.setInt32(12, this.positionMap.src.h, !0), i.setInt32(0, this.positionMap.dst.x, !0), i.setInt32(4, this.positionMap.dst.y, !0), i.setInt32(8, this.positionMap.dst.w, !0), i.setInt32(12, this.positionMap.dst.h, !0), m("send position pdu");
                        try {
                    ...
                    recordCurrentMousePosition: function(e) {
                        try {
                            var t = this.positionMap,
                                ...
                                i = e.clientY;
                            (0, f.
                                default)(this.currentMousePositionProps, {
                                    clientX: n,
                                    clientY: i,
                    ...
                    generateBuffer: function(e) {
                        ...
                        var n = new ArrayBuffer(t),
                            ...
                            r = new DataView(n, 4),
                            a = new DataView(n, 4);
                        if (i[0] = e.pduType, i[1] = 63 & e.input_event_type, e.pduType === y) r.setUint16(0, e.x, !0), r.setUint16(2, e.y, !0);
                        else if (e.pduType === M) a.setInt16(0, e.x, !0), a.setInt16(2, e.y, !0), a.setInt16(4, e.dx, !0), a.setInt16(6, e.dy, !0);
                        else if (e.pduType === N) {
                    ...
                    debug: function(e) {
                        var t = {};
                        (e.pduType === N ? ["t", "keyCode", "charCode", "key"] : ["t", "x", "y", "dx", "dy", "input_event_type"]).forEach(function(n) {
                            t[n] = e[n]
                        }), m("debug", (0, c.
                            default)(t))
                    },
                    ...
                    transformCtrlCAndCommandC: function(e) {
                        var t = this,
                            n = this;
                        return new E.
                        default (function(i, r) {
                            if (t.isKeyboardEvent(e) && (e.ctrlKey || e.metaKey) && n.isThisKeyIgnoreCase(e, "c")) {
                                n.createParamsFromKeyboardEvent(e);
                                i(n.returnNewEventByTransformCtrlKeyOrCommandKey(e))
                            } else i(e)
                        })
                    },
                    ...
                    _keyMouseEventHandler: function(e) {
                        ...
                        if (-1 !== ["keydown", "keyup"].indexOf(e.type)) t.event_type = 1, a = N, void 0 !== n[e.type] && (t.input_event_type = n[e.type]);
                        else {
                            ...
                            if ((0, f.
                                ...
                                x: u.x,
                                y: u.y
                            }), a = "wheel" === e.type ? M : y, void 0 !== i[e.type] && (t.input_event_type = i[e.type]), -1 !== ["mousedown", "mouseup"].indexOf(e.type)) {
                                var s;
                                switch (e.button) {
                                    case 0:
                                        s = "left";
                        ...
                        if ((0, f.
                            ...
                            numlock: r("NumLock", !1)
                        }), this.isKeyboardEvent(e) && m("processEvent", (0, c.
                            default)(t)), this.processEvent(t), "keydown" === e.type) {
                            var h = (0, f.
                                default)({}, t, {
                                ...
                                var t = (0, _.
                                    ...
                                    default.mark(function t(n) {
                                        ...
                                        default.wrap(function(t) {
                                            for (;;) switch (t.prev = t.next) {
                                                case 0:
                                                    return i = n.data, t.next = 3, O.
                                                default.readBlobAsBuffer(i, i.size);
                                                case 3:
                                                    if (r = t.sent, a = new Int8Array(r), (o = a[0]) !== b) {
                                                        t.next = 14;
                                                        break
                                                    }
                                                    return u = i.slice(8), t.next = 10, O.
                                                default.readBlob(u);
                                                case 10:
                ...
                function g() {
                    ...
                    if (d = arguments, c = this, _ = e, n) {
                        if (void 0 === h) return function(e) {
                            return E = e, h = setTimeout(v, t), p ? I(e) : f
                        }(_);
                        if (S) return h = setTimeout(v, t), I(_)
                    }
                    return void 0 === h && (h = setTimeout(v, t)), f
                }
                return t = a(t) || 0, i(n) && (p = !! n.leading, l = (S = "maxWait" in n) ? u(a(n.maxWait) || 0, t) : l, A = "trailing" in n ? !! n.trailing : A), g.cancel = function() {
                    void 0 !== h && clearTimeout(h), E = 0, d = _ = c = h = void 0
                }, g.flush = function() {
                    return void 0 === h ? f : O(r())
                }, g
            }
        },
        function(e, t, n) {
        ...
        function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.MONITOR_LOG_DASHBOARD_DATACHANNEL_PARSE_SEPARATOR = t.CONFIG = t.
            default = void 0;
            t.
            default = {
        ...
        function(e, t, n) {
            ...
            default = void 0, i.prototype.Get_WaterMarkRGBA = function(e, t, n, i, r, a) {
                if (t && n && i) {
        ...
        function(e, t, n) {
            ...
            default = void 0, i.prototype.isWebGL = function() {
                ...
                e.shaderSource(i, t), e.compileShader(i), e.getShaderParameter(i, e.COMPILE_STATUS) || console.log("Vertex shader failed to compile: " + e.getShaderInfoLog(i));
                var r = e.createShader(e.FRAGMENT_SHADER);
                e.shaderSource(r, n), e.compileShader(r), e.getShaderParameter(r, e.COMPILE_STATUS) || console.log("Fragment shader failed to compile: " + e.getShaderInfoLog(r));
                var a = e.createProgram();
                e.attachShader(a, i), e.attachShader(a, r), e.linkProgram(a), e.getProgramParameter(a, e.LINK_STATUS) || console.log("Program failed to compile: " + e.getProgramInfoLog(a)), e.useProgram(a), this.shaderProgram = a
                ...
                if (o.enable(o.BLEND), o.blendFunc(o.SRC_ALPHA, o.ONE_MINUS_SRC_ALPHA), o && this.glInitSucceed && !(e <= 0 || t <= 0 || !i || !i.length || i.length != e * t * 3 / 2 || n && (n.top < 0 || n.left < 0 || n.left + n.width > e || n.top + n.height > t))) {
                    ...
                    var I = e / 2 * t / 2,
                        D = p.subarray(S, S + I);
                    o.activeTexture(o.TEXTURE1), o.bindTexture(o.TEXTURE_2D, s), o.texImage2D(o.TEXTURE_2D, 0, o.LUMINANCE, e / 2, t / 2, 0, o.LUMINANCE, o.UNSIGNED_BYTE, D);
                    var v = I,
                        O = p.subarray(S + I, S + I + v);
                    o.activeTexture(o.TEXTURE2), o.bindTexture(o.TEXTURE_2D, d), o.texImage2D(o.TEXTURE_2D, 0, o.LUMINANCE, e / 2, t / 2, 0, o.LUMINANCE, o.UNSIGNED_BYTE, O), o.activeTexture(o.TEXTURE3), o.bindTexture(o.TEXTURE_2D, this.cursorTextureRef), this.hasCursor || o.texImage2D(o.TEXTURE_2D, 0, o.RGBA, 1, 1, 0, o.RGBA, o.UNSIGNED_BYTE, this.dummpyCursor), o.activeTexture(o.TEXTURE4), o.bindTexture(o.TEXTURE_2D, this.waterMarkTextureRef), this.hasWaterMark || o.texImage2D(o.TEXTURE_2D, 0, o.RGBA, 1, 1, 0, o.RGBA, o.UNSIGNED_BYTE, this.dummpyWaterMark), o.uniform4f(this.cursorInfoRef, this.cx, this.cy, this.cw, this.ch), o.drawArrays(o.TRIANGLE_STRIP, 0, 4), this.hasWholeFrame = 1
                }
        ...
        function(e, t, n) {
            ...
            var i = n(20),
                ...
                T = r(n(103));
            n(206);
            var M, N, P, b, k, w, L, U, V, x, G, W, F, H, K, B = r(n(71)),
                j = n(207),
                Q = r(n(208)),
                Y = r(n(209)),
                X = r(n(200)),
                ...
                q = function e() {
                    ...
                    try {
                        B.
                        default.add_monitor("JSBN:".concat(e.buildNumber)), J("JSBN:".concat(e.buildNumber))
                    } catch (e) {
                        J(e)
                    }
                    if (this.isSupportThread = "object" === ("undefined" == typeof WebAssembly ? "undefined" : (0, c.
                        default)(WebAssembly)) && "function" == typeof Worker, !this.isSupportThread) throw new Error("Webassemly or worker is not supported on this browser");
                    _.
                    default.reinit(), this.audioCtx = new(window.AudioContext || window.webkitAudioContext), this.audioPlayNode = null, this.audioRecordNode = null, this.webrtcAudioNode = null, this.videoRenderArray = [], this.videoCaptureValue = null, this.audioRenderArray = [], this.audioCapture = null, this.display = [], this.AudioMediaStream = null, this.VideoMediaStram = null, this.isMediaStart = !1, this.sampleRate = this.audioCtx.sampleRate, this.videoRenderIntervalHandle = null, this.audioDomNode = null, this.audioSpeakerValue = null, this.audionodebuffersize = this.sampleRate <= 32e3 || f.
                    default.browser.isSafari ? 2048 : 1024, this.audionoderecordbuffersize = 2048, this.lastresidual = null, this.currentactive = 0, this.audioPlay = !1, this.sharingInterval = null, this.sharingIntervalTime = 100, this.sharingDisplay = null, this.currentshareactive = 0, this.videorenderinterval = 10, this.waterMarkCanvas = document.createElement("canvas"), this.isSetCursor = !1, this.captureAudioStatus = h.AUDIO_ILLEGAL, this.logon = !1, this.canvas = null, this.firstSetDelay = !0, this.isSupportAudioWorklet = "function" == typeof AudioWorklet, this.isSupportImageCapture = f.
                    default.isSupportImageCapture(), this.isSupportOffscreenCanvas = "function" == typeof OffscreenCanvas && !f.
                    default.isOpera65(), this.isCaputureNodeConnect = !1, this.audioWorkletJsPath = null, this.videoCaptureInterval = 0, this.isStartVideoCapture = !1, this.videoCaptureWidth = 0, this.videoCaptureHeight = 0, this.videoCaptureContext = null, this.isCreateVideoWaterMark = !1, this.videoWaterMarkName = "", this.sharingWaterMarkName = "", this.isCreateSharingWaterMark = !1, this.isStartDesktopSharing = !1, this.desktopSharingValue = null, this.desktopCaptureContext = null, this.desktopSharingMediaStram = null, this.desktopSharingCaptureWidth = 0, this.desktopSharingCaptureHeight = 0, this.desktopSharingSend = !1, this.isdesktopCaptureLoadedmetadata = !1, this.captureVideoOutputCanvasDomList = [], this.isVideoCaptureLoadedmetadata = !1, this.VALUE_CACHE_FOR_START_CAPTURE_VIDEO = {}, this.isMediaDevicesGetUserMediaNow = !1, this.vMonitorCount = 0, this.sMonitorCount = 0, this.mMonitorCount = 0, this.videoImageCapture, this.wecancapturevideo = !0, this.isSendVideoOfflineCanvas = !1, _.
                    default.mediaSDKHandle = this, this._preloadMeetingParam = null, this.is32bitbrowser = -1 != navigator.userAgent.indexOf("WOW64"), this.flipSend = !0, this.mtu_size = 0, this.sharingImageCapture = null, this.sharingRenderCanvas = null, this.VideoRenderObj = null, this.SharingRenderObj = null, this.rtcConnectionA = null, this.rtcConnectionB = null, this.sharingWidthAndHeightInfo = {
                        ctiveNodeID: 0,
                        height: 0,
                        logicHeight: 0,
                        logicWidth: 0,
                        width: 0
                    }, this.remoteControl = null, this.listenInitEvent = (0, C.
                        default)(function() {
                        this._listenInitEvent()
                    }).bind(this), this.isInitVideoDataChannel = !1, this.isInitAudioDataChannel = !1, this.rtcPeerConnectionList = [], this.isDestroy = !1, t.ivObj && (_.
                        default.ivObj = t.ivObj)
                };
            q.buildNumber = 5793, q.version = "7.0.5793", q.prototype = {
                ...
                JsMediaSDK_PreLoad: function(e, t) {
                    ...
                    }), this._preloadMeetingParam = e, E.Start_Monitor(), B.
                    default.add_monitor("JSPLD")
                },
                recordSharingParamInfo: function() {
                    var e = this;
                    A.
                    default.on(h.SHARING_PARAM_INFO_FROM_SOCKET, function(t, n) {
                        (0, d.
                            default)(e.sharingWidthAndHeightInfo, n.body)
                    })
                },
                ...
                setCallback: function(e) {
                    if (!(0, O.
                        default)(e)) throw new Error("callback must be function");
                    _.
                    default._Notify_APPUI = e
                },
                setPropsBeforeInit: function(e) {
                    e.callback && this.setCallback(e.callback), e.audioWorkletPath && (this.audioWorkletJsPath = e.audioWorkletPath), e.isEnableListenInitEvent && this.listenInitEvent(), e.e2eEncrypt ? _.
                    default.e2eencrypt = !0 : _.
                    default.e2eencrypt = !1
                },
                checkISDatachannelOrWebsocket: function() {
                    ...
                    A.
                    default.on(h.PUBSUB_EVT.DC_COMING_MESSAGE, function() {
                        e()
                    }), A.
                    default.on(h.VIDEO_DATA_FROM_WORKER, function(e, n) {
                        -1 !== [2, 7].indexOf(n[0]) && t()
                    })
                },
                initVideoDataChannel: (K = (0, s.
                    default)(u.
                    default.mark(function e(t, n) {
                        var i;
                        return u.
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return e.abrupt("return");
                                case 2:
                                    this.isInitVideoDataChannel = !0, B.
                                default.add_monitor("INITVDC"), J("initVideoDataChannel", t), (i = new j.RTCPeerConnectionUtil).setUserid(n), i.setConnectionType(m.ConnectionType.VIDEO), J("rtc", i), i.onConnectionCreated(function() {
                                    var e = (0, s.
                                        default)(u.
                                        default.mark(function e(t) {
                                            var n, r, a;
                                            ...
                                            default.wrap(function(e) {
                                                for (;;) switch (e.prev = e.next) {
                                                    case 0:
                                                        return n = t.localDescription, J("localDesc", n), _.
                                                    default.Notify_APPUI_SAFE(h.SEND_MESSAGE_TO_RWG, {
                                                    ...
                                                    case 5:
                                                        r = e.sent, J("jsEvent.PUBSUB_EVT.ZOOM_CONNECTION_VIDEO_OFFER_RESPONSE_EVT", r), i.setRemoteDescription(r.answer), i.closeIfTimeout(), a = r.answer.sdp.match(/a=candidate:.+/)[0], J("received candidate", a), a = a.replace(/^a=/, ""), i.addIceCandidate(a), i.listenOnDataAndSend(h.VIDEO_DATA_FROM_WORKER), i.onMessage(function(e) {
                                                            var t = new Uint8Array(e);
                                                            A.
                                                            default.trigger(h.PUBSUB_EVT.DC_COMING_MESSAGE), t[0] == h.MEDIA_VIDEO_REPORT_DROP_RATIO || t[0] == h.MEDIA_VIDEO_REPORT_RTT ? E.pushMessageToWorker(m.WORKER_TYPE.VIDEO_ENCODE, e, void 0, !0) : E.pushMessageToWorker(m.WORKER_TYPE.VIDEO_DECODE, e, void 0, !0)
                                    ...
                                    J.warn("initConnection", e), B.
                                    default.add_monitor("INITVDCERR:" + e.message)
                                }), this.rtcPeerConnectionList.push(i), A.
                                default.on(h.PUBSUB_EVT.VIDEO_DATACHANNEL_SPEED, function(e, t) {
                                    J("VIDEO_DATACHANNEL_SPEED", t), E.pushMessageToWorker(m.WORKER_TYPE.VIDEO_ENCODE, {
                                        speed: t
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return e.abrupt("return");
                                case 2:
                                    this.isInitAudioDataChannel = !0, B.
                                default.add_monitor("INITADC"), J("initAudioDataChannel", t), (i = new j.RTCPeerConnectionUtil).setUserid(n), i.setConnectionType(m.ConnectionType.AUDIO), J("rtc", i), i.onConnectionCreated(function() {
                                    var e = (0, s.
                                        default)(u.
                                        default.mark(function e(t) {
                                            var n, r, a;
                                            ...
                                            default.wrap(function(e) {
                                                for (;;) switch (e.prev = e.next) {
                                                    ...
                                                    case 5:
                                                        r = e.sent, J("answer", r), i.setRemoteDescription(r.answer), i.closeIfTimeout(), a = r.answer.sdp.match(/a=candidate:.+/)[0], J("received candidate", a), a = a.replace(/^a=/, ""), i.addIceCandidate(a), i.listenOnDataAndSendAudio(h.AUDIO_DATA_FROM_WORKER), i.onMessage(function(e) {
                                ...
                                }()), i.initConnection(t, "ZoomWebclientAudioDataChannel").
                                catch (function(e) {
                                    J.warn("initConnection", e), B.
                                    default.add_monitor("INITADCERR:" + e.message)
                ...
                initVideoEncode: (F = (0, s.
                    default)(u.
                    default.mark(function e(t, n, i) {
                        var r, a, o, s, d, c, l, h, p = arguments;
                        return u.
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return r = p.length > 3 && void 0 !== p[3] && p[3], a = p.length > 4 ? p[4] : void 0, o = p.length > 5 ? p[5] : void 0, J("initVideoEncode"), B.
                                default.add_monitor("INITVE"), e.next = 7, f.
                                default.isSDKSupportMultiThread();
                                case 7:
                                    return s = e.sent, e.next = 10, f.
                                default.isSDKSupportSIMD();
                                case 10:
                                    return d = e.sent, c = {}, s ? (c.workerJsFileUrl = t.videoMtWorkerPath, c.workerWasmFileUrl = t.videoMtWasm) : d ? (c.workerJsFileUrl = t.videoSIMDWorkerPath, c.workerWasmFileUrl = t.videoSIMDWasm) : (c.workerJsFileUrl = t.videoWorkerPath, c.workerWasmFileUrl = t.videoWasm), this.throwErrorWhenParameterIsEmpty(c.workerJsFileUrl), this.throwErrorWhenParameterIsEmpty(c.workerWasmFileUrl), l = new URL(n).searchParams.get("cid"), this.initVideoDataChannel(l, i), _.
                                default.monitorCid = l, h = {
                                    log: r,
                                    confId: i,
                                    meetingid: a,
                                    meetingnumb: o
                                }, E.setVideoEngineInitProperties(n, h), e.next = 22, E.initVideoEncode(c, this);
                                case 22:
                                    return e.next = 24, I.Video.waitVideoEncodeInitResult();
                                case 24:
                ...
                initVideoDecode: (W = (0, s.
                    ...
                    default.mark(function e(t, n, i) {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return r = p.length > 3 && void 0 !== p[3] && p[3], a = p.length > 4 ? p[4] : void 0, o = p.length > 5 ? p[5] : void 0, J("initVideoDecode"), B.
                                default.add_monitor("INITVD"), e.next = 7, f.
                                default.isSDKSupportMultiThread();
                                case 7:
                                    return s = e.sent, e.next = 10, f.
                                default.isSDKSupportSIMD();
                                ...
                                default.monitorCid = l, h = {
                                    ...
                                    meetingid: a,
                                    meetingnumb: o
                                }, E.setVideoEngineInitProperties(n, h), e.next = 22, E.initVideoDecode(c, this);
                                case 22:
                                    return e.next = 24, I.Video.waitVideoDecodeInitResult();
                                case 24:
                                    return e.abrupt("return", e.sent);
                                case 25:
                                case "end":
                ...
                initAudioEncode: (G = (0, s.
                    ...
                    default.mark(function e(t, n, i) {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return r = c.length > 3 && void 0 !== c[3] && c[3], a = c.length > 4 ? c[4] : void 0, o = c.length > 5 ? c[5] : void 0, J("initAudioEncode"), B.
                                default.add_monitor("INITAE"), _.
                                default.monitorCid = new URL(n).searchParams.get("cid"), this.initAudioDataChannel(_.
                                    default.monitorCid, i), (s = {}).workerJsFileUrl = t.audioWorkerPath, s.workerWasmFileUrl = t.audioWasm, this.throwErrorWhenParameterIsEmpty(s.workerJsFileUrl), this.throwErrorWhenParameterIsEmpty(s.workerWasmFileUrl), d = {
                                    sampleRate: this.audioCtx.sampleRate,
                                    userid: i,
                                    log: r,
                                    meetingid: a,
                                    meetingnumb: o
                                }, E.setAudioEngineInitProperties(n, d), e.next = 16, E.initAudioEncode(s, this);
                                case 16:
                                    return e.next = 18, D.AudioService.waitAudioEncodeInitResult();
                                case 18:
                                    return e.abrupt("return", e.sent);
                                case 19:
                                case "end":
                ...
                initAudioDecode: (x = (0, s.
                    ...
                    default.mark(function e(t, n, i) {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return r = c.length > 3 && void 0 !== c[3] && c[3], a = c.length > 4 ? c[4] : void 0, o = c.length > 5 ? c[5] : void 0, J("initAudioDecode"), B.
                                default.add_monitor("INITAD"), _.
                                default.monitorCid = new URL(n).searchParams.get("cid"), this.initAudioDataChannel(_.
                                    default.monitorCid, i), (s = {}).workerJsFileUrl = t.audioWorkerPath, s.workerWasmFileUrl = t.audioWasm, this.throwErrorWhenParameterIsEmpty(s.workerJsFileUrl), this.throwErrorWhenParameterIsEmpty(s.workerWasmFileUrl), d = {
                                    sampleRate: this.audioCtx.sampleRate,
                                    userid: i,
                                    ...
                                    meetingid: a,
                                    meetingnumb: o
                                }, E.setAudioEngineInitProperties(n, d), e.next = 16, E.initAudioDecode(s, this);
                                case 16:
                                    return e.next = 18, D.AudioService.waitAudioDecodeInitResult();
                                case 18:
                                    return e.abrupt("return", e.sent);
                                case 19:
                                case "end":
                ...
                initSharingDecode: (V = (0, s.
                    default)(u.
                    default.mark(function e(t, n, i) {
                        var r, a, o, s, d, c, l, h = arguments;
                        return u.
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return r = h.length > 3 && void 0 !== h[3] && h[3], a = h.length > 4 ? h[4] : void 0, o = h.length > 5 ? h[5] : void 0, J("initSharingDecode"), B.
                                default.add_monitor("INITSD"), this.recordSharingParamInfo(), _.
                                default.monitorCid = new URL(n).searchParams.get("cid"), e.next = 9, f.
                                default.isSDKSupportMultiThread();
                                case 9:
                                    return s = e.sent, e.next = 12, f.
                                default.isSDKSupportSIMD();
                                case 12:
                                    return d = e.sent, c = {}, s ? (c.workerJsFileUrl = t.sharingMtWorkerPath, c.workerWasmFileUrl = t.videoMtWasm) : d ? (c.workerJsFileUrl = t.sharingSIMDWorkerPath, c.workerWasmFileUrl = t.videoSIMDWasm) : (c.workerJsFileUrl = t.sharingWorkerPath, c.workerWasmFileUrl = t.videoWasm), this.throwErrorWhenParameterIsEmpty(c.workerJsFileUrl), this.throwErrorWhenParameterIsEmpty(c.workerWasmFileUrl), l = {
                                        log: r,
                                        userid: i,
                                        meetingid: a,
                                        meetingnumb: o,
                                        isSupportMultiThread: s
                                    }, E.setSharingEngineInitProperties(n, l), e.next = 21, E.initSharingDecode(c, this);
                                case 21:
                                    return e.next = 23, v.Sharing.waitSharingDecodeResult();
                                case 23:
                                    return e.abrupt("return", e.sent);
                                case 24:
                                case "end":
                ...
                initSharingEncode: (U = (0, s.
                    ...
                    default.mark(function e(t, n, i) {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return r = h.length > 3 && void 0 !== h[3] && h[3], a = h.length > 4 ? h[4] : void 0, o = h.length > 5 ? h[5] : void 0, J("initSharingEncode"), B.
                                default.add_monitor("INITSE"), e.next = 7, f.
                                default.isSDKSupportMultiThread();
                                case 7:
                                    return s = e.sent, e.next = 10, f.
                                default.isSDKSupportSIMD();
                                case 10:
                                    return d = e.sent, c = {}, s ? (c.workerJsFileUrl = t.sharingMtWorkerPath, c.workerWasmFileUrl = t.videoMtWasm) : d ? (c.workerJsFileUrl = t.sharingSIMDWorkerPath, c.workerWasmFileUrl = t.videoSIMDWasm) : (c.workerJsFileUrl = t.sharingWorkerPath, c.workerWasmFileUrl = t.videoWasm), this.throwErrorWhenParameterIsEmpty(c.workerJsFileUrl), this.throwErrorWhenParameterIsEmpty(c.workerWasmFileUrl), _.
                                default.monitorCid = new URL(n).searchParams.get("cid"), l = {
                                    log: r,
                                    userid: i,
                                    meetingid: a,
                                    meetingnumb: o,
                                    isSupportMultiThread: s
                                }, E.setSharingEngineInitProperties(n, l), e.next = 20, E.initSharingEncode(c, this);
                                case 20:
                                    return e.next = 22, v.Sharing.waitSharingEncodeResult();
                                case 22:
                                    return e.abrupt("return", e.sent);
                                case 23:
                                case "end":
                ...
                _listenInitEvent: function() {
                    var e = {
                        ...
                        SHARING_DECODE: v.SHARING_INIT_EVENT.SHARING_DECODE_SUCCESS,
                        SHARING_ENCODE: v.SHARING_INIT_EVENT.SHARING_ENCODE_SUCCESS
                    }, t = {
                            ...
                            SHARING_DECODE: v.SHARING_INIT_EVENT.SHARING_DECODE_FAILED,
                            SHARING_ENCODE: v.SHARING_INIT_EVENT.SHARING_ENCODE_FAILED
                        }, n = {
                            VIDEO_ENCODE_INIT: {
                            ...
                            default)(e).map(function(n) {
                            return {
                                k: n,
                                promise: new a.
                                default (function(i, r) {
                                    A.
                                    default.on(e[n], function() {
                                        i(!0)
                                    }), A.
                                    default.on(t[n], function() {
                                        i(!1)
                                    })
                                })
                            }
                            ...
                            return e.promise = e.promise.then(function(t) {
                                return J("init => ".concat(e.k, " => ").concat(t)), t ? n[e.k] && n[e.k].success && _.
                                default.Notify_APPUI(n[e.k].success, n[e.k].callbackDataValue) : n[e.k] && n[e.k].failed && _.
                                default.Notify_APPUI(n[e.k].failed, n[e.k].callbackDataValue), t
                            }), e
                        }),
                        r = {
                            video: {
                ...
                StartDesktopMediaCapture: (L = (0, s.
                    default)(u.
                    default.mark(function e() {
                        var t, n, i, r, a;
                        return u.
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    t = this, f.
                                default.browser.isEdge ? (n = this.handleDesktopCapture.bind(this), i = this.handleCaptureError.bind(this), navigator.getDisplayMedia({
                                    video: !0
                                }).then(n, i)):
                                    navigator.mediaDevices.getDisplayMedia ? (r = this.handleDesktopCapture.bind(this), a = this.handleCaptureError.bind(this), navigator.mediaDevices.getDisplayMedia({
                                        video: !0
                                        ...
                                        if (e) {
                                            ...
                                            t.StopSharingCapture(), r && (B.
                                                default.add_monitor("SCSF"), _.
                                                default.Notify_APPUI(r, null))
                                        } else navigator.mediaDevices.getUserMedia(i).then(function(e) {
                                            t.desktopSharingMediaStram = e, _.
                                            default.Notify_APPUI(h.DESKTOP_SHARING_CAPTURE_SUCCESS, null), t.desktopSharingMediaStram.getVideoTracks()[0].onended = function() {
                                                B.
                                                default.add_monitor("SSBB"), _.
                                                default.Notify_APPUI(h.USER_STOP_DESKTOP_SHARING, null), t.StopSharingCapture()
                                            }, t.Start_Desktop_Sharing()
                                        }).
                                        catch (function(e) {
                                            B.
                                            default.add_monitor("SCCF"), t.StopSharingCapture(), _.
                                            default.Notify_APPUI(h.DESKTOP_SHARING_ERROR, null)
                                        })
                                    });
                                case 2:
                                case "end":
                ...
                StartVideoMediaCapture: (w = (0, s.
                    ...
                    default.mark(function e() {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return this.EndVideoMediaStream(), t = null, n = null, i = null, 0, this.videoCaptureValue && (t = this.videoCaptureValue.VideoSelectValue), i = !! this.videoCaptureValue && ( !! f.
                                        default.browser.isSafari || {
                                ...
                                case 15:
                                    ...
                                    break;
                                case 18:
                                    return e.prev = 18, e.t0 = e.
                                    catch (12), e.next = 22, navigator.mediaDevices.getUserMedia((0, d.
                                        default)({}, n, {
                                        video: !0
                                    }));
                                case 22:
                                    a = e.sent;
                                case 23:
                                    return this.isMediaDevicesGetUserMediaNow = !1, J("mediaStream is ok"), this.videoCaptureValue = r, e.next = 28, this.handleVideoCapture(a);
                                case 28:
                                    e.sent && (_.
                                        default.monitorVideoCapture = !0, _.
                                        default.Notify_APPUI(h.START_VIDEO_CAPTURE_SUCCESS, null)), e.next = 35;
                                    break;
                                case 32:
                                    e.prev = 32, e.t1 = e.
                                    catch (9), this.handleVideoError(e.t1);
                                case 35:
                                case "end":
                                    return e.stop()
                            }
                ...
                Start_Audio_Play: function() {
                    if (this.audioPlay = !0, this.isSupportAudioWorklet) _.
                    default.AudioNode && _.
                    default.AudioNode.postCMD("startPlayAudio", null);
                ...
                Stop_Audio_Play: function() {
                    if (E.UpdateAudioPlayStatus(!1), this.isSupportAudioWorklet) _.
                    default.AudioNode && _.
                    default.AudioNode.postCMD("stopPlayAudio", null);
                ...
                Remove_Audio_Play: function() {
                    if (E.UpdateAudioPlayStatus(!1), this.audioPlay = !1, this.isSupportAudioWorklet) _.
                    default.AudioNode && _.
                    default.AudioNode.postCMD("stopPlayAudio", null);
                ...
                Start_Audio_Capture: function() {
                    if (!(this.audioRecordNode && this.audioCtx.destination && this.AudioMediaStream))
                        if (this.AudioMediaStream) {
                            ...
                            if (this.webrtcAudioNode = e, this.isSupportAudioWorklet) this.isCaputureNodeConnect || (this.webrtcAudioNode.connect(_.
                                    default.AudioNode), _.
                                default.AudioNode.postCMD("StartCaptureAudio", null), this.isCaputureNodeConnect = !0);
                            else {
                ...
                Stop_Audio_Capture: function() {
                    this.captureAudioStatus = h.AUDIO_STOP, E.Notify_Audio_Thread_Status(_.
                        default.SPECIAL_ID, h.AUDIO_STOP)
                },
                    ...
                    if (this.VideoMediaStram) {
                        ...
                        default (function(n, i) {
                            var r = function e() {
                                ...
                                default.monitorVideoUserID = t.videoCaptureValue.ssid, _.
                                default.Notify_APPUI(h.CURRENT_CAPTURE_VIDEO_WIDTH_HEIGHT, {
                                    width: n,
                                    height: i
                                })
                            };
                                        ...
                                        default.wrap(function(t) {
                                            for (;;) switch (t.prev = t.next) {
                                                ...
                                                case 5:
                                                    ...
                                                    try {
                                                        e.sharingOffscreenCanvas = e.desktopSharingValue.canvas.transferControlToOffscreen(), d = _.
                                                        default.SPECIAL_ID, _.
                                                        default.localSharingEncMGR && (c = _.
                                                            default.localSharingEncMGR.map.get(d)) && (l = {
                                                ...
                                                case 22:
                                                    _.
                                                default.monitorSharingUserID = e.desktopSharingValue.ssid, E.Notify_Sharing_Encode_Thread({
                                                ...
                                                default.Notify_APPUI(h.CURRENT_DESKTOP_SHARING_WIDTH_HEIGHT, {
                                                    width: r,
                                                    height: a
                                                });
                                                case 25:
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return e.abrupt("return");
                                case 2:
                                    if (this, !this.isSupportImageCapture) {
                                        e.next = 21;
                                        break
                                    }
                                    return e.prev = 4, e.next = 7, this.sharingImageCapture.grabFrame();
                                case 7:
                                    r = e.sent, t = r.width, n = r.height, a = _.
                                default.SPECIAL_ID, _.
                                default.localSharingEncMGR && (o = _.
                                    default.localSharingEncMGR.map.get(a)) && (s = {
                                    command: "encodeSharingFrame",
                                    data: r,
                                    isImage: !0
                                ...
                                case 24:
                                    t == this.desktopSharingCaptureWidth && n == this.desktopSharingCaptureHeight || (_.
                                        default.Notify_APPUI(h.CURRENT_DESKTOP_SHARING_WIDTH_HEIGHT, {
                                            width: t,
                                            height: n
                                        }), this.desktopSharingCaptureWidth = t, this.desktopSharingCaptureHeight = n);
                                    try {
                                        this.isdesktopCaptureLoadedmetadata && i && (this.desktopSharingValue.canvas.width = t, this.desktopSharingValue.canvas.height = n, d = this.desktopCaptureContext, !this.is32bitbrowser || this.flipSend ? (d.drawImage(i, 0, 0, t, n, 0, 0, t, n), c = d.getImageData(0, 0, t, n), E.Sharing_Encode_Frame(_.
                                            default.SPECIAL_ID, c.data, c.data.length, 0, t, n), this.flipSend = !1) : (this.flipSend = !0, E.Sharing_Encode_Frame(_.
                                            default.SPECIAL_ID, null, 0, 0, 0, 0)))
                                    } catch (e) {
                                        B.
                                        default.add_monitor3("GIDF"), setTimeout(function() {
                                            E.Sharing_Encode_Frame(_.
                                                default.SPECIAL_ID, null, 0, 0, 0, 0)
                                        }, 1e3)
                                    }
                                case 26:
                    ...
                    default.mark(function e() {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                ...
                                case 9:
                                    if (t = this, r = this.videoCaptureWidth, a = this.videoCaptureHeight, n = r, i = a, this.isSupportImageCapture || (o = this.videoCaptureValue.videoCtrl, n = o.videoWidth, i = o.videoHeight), r && a && (n !== r || i !== a) && (J("video width/height changed old => begin", r, a, n, i), _.
                                        default.Notify_APPUI(h.CURRENT_CAPTURE_VIDEO_WIDTH_HEIGHT, {
                                            width: n,
                                            height: i
                                        }), E.Notify_Video_Encode_Thread({
                ...
                Remove_Audio_Capture: function() {
                    if (E.Notify_Audio_Thread_Status(_.
                        default.SPECIAL_ID, h.AUDIO_REMOVE), this.captureAudioStatus = h.AUDIO_REMOVE, this.firstSetDelay = !0, this.audioRecordNode) {
                        try {
                    ...
                    if (this.webrtcAudioNode && this.isSupportAudioWorklet && _.
                        default.AudioNode) {
                        try {
                            this.webrtcAudioNode.disconnect(_.
                                default.AudioNode)
                        } catch (e) {
                            this.JsMediaSDK_Log(e)
                        }
                ...
                UnMuteAudio: function() {
                    this.captureAudioStatus = h.AUDIO_START, E.Notify_Audio_Thread_Status(_.
                        default.SPECIAL_ID, h.AUDIO_START)
                },
                MuteAudio: function() {
                ...
                handleDesktopCapture: function(e) {
                    ...
                    this.desktopSharingMediaStram.getVideoTracks()[0].onended = function() {
                        ...
                        default.add_monitor("SSBB"), _.
                        default.Notify_APPUI(h.USER_STOP_DESKTOP_SHARING, null), t.StopSharingCapture()
                    }, this.Start_Desktop_Sharing(), _.
                    default.Notify_APPUI(h.DESKTOP_SHARING_CAPTURE_SUCCESS, null)
                },
                handleCaptureError: function(e) {
                    this.StopSharingCapture(), B.
                    default.add_monitor("SCCF"), "Permission denied by system" == e.message ? _.
                    default.Notify_APPUI(h.DESKTOP_SHARING_SYSTEM_ERROR, null) : _.
                    default.Notify_APPUI(h.DESKTOP_SHARING_ERROR, null)
                },
                handleAudioCapture: function(e) {
                    _.
                    default.monitorAudioCapture = !0, _.
                    default.Notify_APPUI(h.USER_GRANT_CAPTURE_AUDIO, null), this.AudioMediaStream = e, this.Start_Audio_Capture()
                },
                            ...
                            default.mark(function i(r, a) {
                                ...
                                default.wrap(function(i) {
                                    for (;;) switch (i.prev = i.next) {
                                        ...
                                        case 11:
                                            i.prev = 11, i.t0 = i.
                                            catch (4), J("Start_Video_Capture", i.t0), a(new Error("media stream is ok, but start video capture fail"));
                                        case 15:
                                        case "end":
                                            return i.stop()
                                    }
                ...
                handleAudioError: function(e) {
                    B.
                    default.add_monitor("HADF"), this.AudioMediaStream = null, _.
                    default.monitorAudioCapture = !1, _.
                    default.Notify_APPUI(h.USER_FORBIDDED_CAPTURE_AUDIO, null)
                },
                handleVideoError: function(e) {
                    _.
                    default.monitorVideoCapture = !1, J("handleVideoError", e);
                    e instanceof p.CameraOccupiedError || e.name && -1 !== ["NotReadableError", "SourceUnavailableError"].indexOf(e.name) ? _.
                    default.Notify_APPUI(h.USER_CAMERA_IS_TAKEN_BY_OTHER_PROGRAMS, null) : (B.
                        default.add_monitor("HVDF"), _.
                        default.Notify_APPUI(h.USER_FORBIDDED_CAPTURE_VIDEO, null)), this.Stop_Video_Capture()
                },
                chromeAecWorkAround: (P = (0, s.
                    default)(u.
                    default.mark(function e(t) {
                        var n, i, r, a, o, s;
                        return u.
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return e.abrupt("return", !1);
                                case 2:
                                    return n = null, i = null, r = new MediaStream, a = {
                                        offerVideo: !0,
                                        offerAudio: !0,
                                        offerToReceiveAudio: !1,
                                        offerToReceiveVideo: !1
                                    }, n = new RTCPeerConnection, i = new RTCPeerConnection, n.onicecandidate = function(e) {
                                        return e.candidate && i.addIceCandidate(new RTCIceCandidate(e.candidate))
                                    }, i.onicecandidate = function(e) {
                                        return e.candidate && n.addIceCandidate(new RTCIceCandidate(e.candidate))
                                    }, i.ontrack = function(e) {
                                        e.streams[0].getTracks().forEach(function(e) {
                                            r.addTrack(e)
                                        })
                                    }, n.addStream(t), e.next = 14, n.createOffer(a);
                                case 14:
                                    return o = e.sent, e.next = 17, n.setLocalDescription(o);
                                case 17:
                                    return e.next = 19, i.setRemoteDescription(o);
                                case 19:
                                    return e.next = 21, i.createAnswer();
                                case 21:
                                    return s = e.sent, e.next = 24, i.setLocalDescription(s);
                                case 24:
                                    return e.next = 26, n.setRemoteDescription(s);
                                case 26:
                                    return this.rtcConnectionA = n, this.rtcConnectionB = i, e.abrupt("return", r);
                                case 29:
                                case "end":
                                    return e.stop()
                            }
                ...
                Notify_MeidaSDK: (N = (0, s.
                    default)(u.
                    default.mark(function e(t, n) {
                        var i, r, o, s, c, p, S, I, D, v, O, C, T, M, N, P, b, k, w, L, U, V = this;
                        return u.
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    J(t, n), i = 0, B.
                                default.add_monitor2("B" + t), e.t0 = t, e.next = e.t0 === h.START_MEDIA ? 6:
                                    e.t0 === h.ADD_RENDER_VIDEO ? 9 : e.t0 === h.STOP_RENDER_VIDEO ? 13 : e.t0 === h.SWITCH_CANVAS_FOR_VIDEO_CAPTURE ? 18 : e.t0 === h.START_CAPTURE_VIDEO ? 24 : e.t0 === h.STOP_CAPTURE_VIDEO ? 32 : e.t0 === h.ADD_RENDER_AUDIO ? 35 : e.t0 === h.STOP_RENDER_AUDIO ? 37 : e.t0 === h.UNMUTE_AUDIO ? 39 : e.t0 === h.MUTE_AUDIO ? 41 : e.t0 === h.START_SHARING ? 43 : e.t0 === h.STOP_SHARING ? 49 : e.t0 === h.CHANGE_FRAME_RATE ? 57 : e.t0 === h.CHANGE_VIDEO_RESOLUTION ? 58 : e.t0 === h.CHANGE_AUDIO_SPEAKER ? 59 : e.t0 === h.CHANGE_VIDEO_CAPTURE_DEVICE ? 61 : e.t0 === h.CHANGE_CURRENT_ACTIVE_SSRC ? 65 : e.t0 === h.CHANGE_CURRENT_SHARING_ACTIVE_SSRC ? 69 : e.t0 === h.LEAVE_MEETING ? 72 : e.t0 === h.MEETING_FAIL_OVER ? 74 : e.t0 === h.END_MEDIA ? 76 : e.t0 === h.CHANGE_AUDIO_MIC ? 80 : e.t0 === h.WEBRTC_RESTART ? 83 : e.t0 === h.LEAVE_COMPUTER_AUDIO ? 85 : e.t0 === h.JOIN_COMPUTER_AUDIO ? 96 : e.t0 === h.START_REMOTE_CONTROL ? 147 : e.t0 === h.CANCEL_REMOTE_CONTROL ? 159 : e.t0 === h.UPDATE_REMOTE_CONTROL_PROPERTIES ? 161 : e.t0 === h.RESEND_REMOTE_CONTROL_POSITION_PDU ? 163 : e.t0 === h.START_DESKTOP_SHARING ? 165 : e.t0 === h.STOP_DESKTOP_SHARING ? 179 : e.t0 === h.PAUSE_DESKTOP_SHARING ? 188 : e.t0 === h.RESUME_DESKTOP_SHARING ? 196 : e.t0 === h.CHECK_CHROME_SHARING_EXTENSION ? 205 : e.t0 === h.COMMAND_SOCKET_MESSAGE_NOTIFY ? 211 : e.t0 === h.USER_NODE_LIST ? 223 : 225;
                                    break;
                                case 6:
                                    return this.isMediaStart = !0, this.StartAudioMediaCapture(), e.abrupt("break", 226);
                                case 9:
                                    if (this.isCreateVideoWaterMark = n.enableWaterMark, this.isCreateVideoWaterMark ? this.videoWaterMarkName = n.waterMarkText : this.videoWaterMarkName = "", this.isSupportOffscreenCanvas) try {
                                        r = n.canvas.id, o = _.
                                        default.SPECIAL_ID, _.
                                        default.localVideoDecMGR && (s = n.canvas.transferControlToOffscreen(), (c = _.
                                            default.localVideoDecMGR.map.get(o)) && (p = {
                                    ...
                                    } else this.videoRenderArray.push(n), this.VideoRenderObj || (this.VideoRenderObj = new Q.
                                        default ((0, d.
                                            default)({}, {
                                            Notify_APPUI: _.
                                            default.Notify_APPUI.bind(_.
                                                default),
                                ...
                                case 13:
                                    ...
                                    return e.abrupt("break", 226);
                                case 18:
                                    return S = [], n instanceof Array ? S = n : S.push(n), I = this.videoCaptureValue.canvasCtrlList, D = I.filter(function(e) {
                                        return -1 !== S.indexOf(e.k)
                                    }).map(function(e) {
                                        return e.dom
                                    }), this.switchCanvasForVideoCapture(D), e.abrupt("break", 226);
                                case 24:
                                    if (E.Update_Video_Encrpt(_.
                                            default.e2eencrypt), n.mode ? this.isSupportImageCapture = f.
                                        default.isSupportImageCapture() : this.isSupportImageCapture = !1, E.isVideoEncodeHandleReady()) {
                                        e.next = 30;
                                        break
                                    }
                                    return J.warn("not isVideoEncodeHandleReady so return"), B.
                                default.add_monitor("not isVideoEncodeHandleReady so return"), e.abrupt("return");
                                case 30:
                                    if (this.isStartVideoCapture) J.warn("video capture is already started, do not call again.");
                                    else {
                                        if (this.VALUE_CACHE_FOR_START_CAPTURE_VIDEO = (0, d.
                                            default)({}, n), this.isStartVideoCapture = !0, n.canvasCtrlList = [], n.canvas instanceof Array) {
                                            for (i = 0; i < n.canvas.length; i++)
                                                if (n.canvasCtrlList.push({
                                                    k: n.canvas[i],
                                                    dom: f.
                                                    default.getDocumentHandle(n.canvas[i])
                                                }), this.isSupportImageCapture) try {
                                                    E.transportOfflineCanvas(f.
                                                        default.getDocumentHandle(n.canvas[i]).transferControlToOffscreen(), n.canvas[i])
                                                } catch (e) {}
                                                this.isSupportImageCapture && (this.isSendVideoOfflineCanvas = !0)
                                        } else n.canvasCtrlList.push({
                                            k: n.canvas,
                                            dom: f.
                                            default.getDocumentHandle(n.canvas)
                                        });
                                        n.canvasCtrl = n.canvasCtrlList[0].dom, this.captureVideoOutputCanvasDomList = [].concat(n.canvasCtrl), f.
                                        default.browser.isSafari ? ((v = document.createElement("video")).setAttribute("style", "position:fixed;top:-10000px;left:-10000px;visibility:hidden;"), document.body.appendChild(v), n.videoCtrl = v) : n.videoCtrl = f.
                                        default.getDocumentHandle(n.video), this.videoCaptureValue = n, this.Start_Video_Capture()
                                    }
                                    return e.abrupt("break", 226);
                                case 32:
                                    return O = this, e.abrupt("return", new a.
                                        default (function(e, t) {
                                            try {
                                                if (V.isMediaDevicesGetUserMediaNow) return _.
                                                default.Notify_APPUI(h.STOP_VIDEO_CAPTURE_FAILED, null), t(new Error("Too many calls : the device is opening camera now, cannot stop video capture"));
                                                O.isStartVideoCapture && O.Stop_Video_Capture(), _.
                                                default.Notify_APPUI(h.STOP_VIDEO_CAPTURE_SUCCESS, null), e(!0)
                                            } catch (e) {
                                                _.
                                                default.Notify_APPUI(h.STOP_VIDEO_CAPTURE_FAILED, null), t(e)
                                            }
                                        }));
                                case 35:
                                    return 0 == this.audioRenderArray.length && (this.audioRenderArray.push(n), this.Start_Audio_Play()), e.abrupt("break", 226);
                                case 37:
                                    ...
                                    return e.abrupt("break", 226);
                                case 39:
                                    return this.UnMuteAudio(), e.abrupt("break", 226);
                                case 41:
                                    return this.MuteAudio(), e.abrupt("break", 226);
                                case 43:
                                    if (this.currentshareactive = n.ssrc, null == this.currentshareactive && B.
                                        default.add_monitor2("SSRC"), this.isCreateSharingWaterMark = n.enableWaterMark, this.isCreateSharingWaterMark ? this.sharingWaterMarkName = n.waterMarkText : this.sharingWaterMarkName = "", this.isSupportOffscreenCanvas) try {
                                        o = _.
                                        default.SPECIAL_ID, _.
                                        default.localSharingDecMGR && (this.sharingRenderCanvas = n.canvas.transferControlToOffscreen(), c = _.
                                            default.localSharingDecMGR.map.get(o), p = {
                                        ...
                                        o = _.
                                        default.SPECIAL_ID, _.
                                        default.localSharingDecMGR && (c = _.
                                            default.localSharingDecMGR.map.get(o), p = {
                                                command: "sharingRenderCanvas",
                                                ssrc: this.currentshareactive,
                                                isCreateSharingWaterMark: this.isCreateSharingWaterMark,
                                    ...
                                    } else this.SharingRenderObj || (this.SharingRenderObj = new Y.
                                        default ((0, d.
                                            default)({}, {
                                            Notify_APPUI: _.
                                            default.Notify_APPUI.bind(_.
                                    ...
                                    if (C = (0, d.
                                        ...
                                        if (this.isStartVideoCapture = !0, C.canvasCtrlList = [], C.canvas instanceof Array)
                                            for (i = 0; i < C.canvas.length; i++) C.canvasCtrlList.push({
                                                k: C.canvas[i],
                                                dom: f.
                                                default.getDocumentHandle(C.canvas[i])
                                            });
                                        else C.canvasCtrlList.push({
                                            k: C.canvas,
                                            dom: f.
                                            default.getDocumentHandle(C.canvas)
                                        });
                                        C.canvasCtrl = C.canvasCtrlList[0].dom, C.videoCtrl = f.
                                        default.getDocumentHandle(C.video), this.videoCaptureValue = C, this.Start_Video_Capture()
                                    }
                                    return e.abrupt("break", 226);
                                case 65:
                                    return this.currentactive != n.ssrc && (this.currentactive = n.ssrc, _.
                                        default.CurrentSSRC = this.currentactive), E.Notify_Audio_Thread_CurrentSSRC(_.
                                        default.CurrentSSRC), this.isSupportOffscreenCanvas ? (o = _.
                                        default.SPECIAL_ID, _.
                                        default.localVideoDecMGR && (c = _.
                                            default.localVideoDecMGR.map.get(o)) && (p = {
                                            command: "CHANGE_CURRENT_ACTIVE_SSRC",
                                            ssrc: n.ssrc
                                        }, c.postMessage(p))) : (this.VideoRenderObj || (this.VideoRenderObj = new Q.
                                        default ((0, d.
                                            default)({}, {
                                            Notify_APPUI: _.
                                            default.Notify_APPUI.bind(_.
                                            ...
                                            isSupportOffscreenCanvas: !1,
                                            jsMediaEngine: E
                                        }))), this.VideoRenderObj.Change_Current_SSRC(this.currentactive)), e.abrupt("break", 226);
                                case 69:
                                    return this.currentshareactive != n.ssrc && (this.currentshareactive = n.ssrc), this.isSupportOffscreenCanvas ? (o = _.
                                        default.SPECIAL_ID, _.
                                        default.localSharingDecMGR && (c = _.
                                            default.localSharingDecMGR.map.get(o)) && (p = {
                                            command: "CHANGE_CURRENT_SHARING_ACTIVE_SSRC",
                                            ssrc: n.ssrc
                                        }, c.postMessage(p))) : (this.SharingRenderObj || (this.SharingRenderObj = new Y.
                                        default ((0, d.
                                            default)({}, {
                                            Notify_APPUI: _.
                                            default.Notify_APPUI.bind(_.
                                            ...
                                            default,
                                            jsMediaEngine: E
                                        }))), this.SharingRenderObj.Change_Current_SSRC(this.currentshareactive)), e.abrupt("break", 226);
                                case 72:
                                    return this.Stop_Audio_Play(), e.abrupt("break", 226);
                                case 74:
                                    return this.Meeting_Fail_Over(n.audio_websocket_address, n.video_websocket_address), e.abrupt("break", 226);
                                case 76:
                                    return J("jsEvent.END_MEDIA"), A.
                                default.trigger(h.PUBSUB_EVT.END_MEDIA), this.destroy().
                                catch (function(e) {
                                    return J.error(e)
                                }), e.abrupt("break", 226);
                                case 80:
                                    if (this.audioCapture && n && this.audioCtx) {
                                        ...
                                        try {
                                            this.isCaputureNodeConnect = !1, this.audioCapture = n, this.audioCtx.sampleRate != this.sampleRate && (this.sampleRate = this.audioCtx.sampleRate, E.Modify_Audio_SampleRate(this.sampleRate)), this.isSupportAudioWorklet ? (this.Start_Audio_Capture(), E.Notify_Audio_Thread_Status(_.
                                                default.SPECIAL_ID, h.AUDIO_START), E.Reset_Aec()) : (isAudioPlaying && this.Start_Audio_Play(), this.Start_Audio_Capture(), E.Reset_Aec())
                                        } catch (e) {
                                            this.JsMediaSDK_Log(e)
                                        }
                                    }
                                    return e.abrupt("return");
                                case 83:
                                    return n && (E.Notify_Audio_Thread_Status(_.
                                        default.SPECIAL_ID, h.AUDIO_START), this.EndAudioMediaStream(), this.Remove_Audio_Capture(), this.audioCapture = n, this.Start_Audio_Capture(), E.Reset_Aec()), e.abrupt("break", 226);
                                case 85:
                                    this.Remove_Audio_Capture(), this.Remove_Audio_Play(), this.EndAudioMediaStream(), this.CloseBoringPeerConnection();
                                    try {
                                        _.
                                        default.AudioNode && (_.
                                            default.AudioNode.port = null)
                                    } catch (e) {
                                        J("AudioNode.port", e)
                                    }
                                    return _.
                                default.AudioNode = null, this.audioCtx && (this.audioCtx.close(), this.isCaputureNodeConnect = !1), this.audioCtx = null, this.audioCapture = null, this.audioPlay = !1, e.abrupt("break", 226);
                                case 96:
                                    if (e.prev = 96, _.
                                        default.monitorAudioUserID = n.CaptureAudioInfo.ssrc, E.Notify_Audio_Encode_Thread({
                                            command: "startAudioEncode",
                                            ssid: n.CaptureAudioInfo.ssrc
                                        }), E.Update_Audio_Encrpt(_.
                                            default.e2eencrypt), this.Remove_Audio_Play(), this.Remove_Audio_Capture(), this.EndAudioMediaStream(), this.CloseBoringPeerConnection(), E.Notify_Audio_Thread_Status(_.
                                            default.SPECIAL_ID, h.AUDIO_START), this.audioCtx && (this.audioCtx.close(), this.isCaputureNodeConnect = !1), T = {}, f.
                                        default.browser.isChrome && !f.
                                        default.isAndroidBrowser() && f.
                                        default.getBrowserVersion() > 74 && (T = {
                                            sampleRate: 16e3
                                        }), this.audioCtx = new(window.AudioContext || window.webkitAudioContext)(T), this.audioCtx.sampleRate != this.sampleRate && (this.sampleRate = this.audioCtx.sampleRate, E.Modify_Audio_SampleRate(this.sampleRate)), !this.isSupportAudioWorklet) {
                                        e.next = 139;
                                        break
                                    }
                                    return O = this, e.next = 114, this.audioCtx.audioWorklet.addModule(O.audioWorkletJsPath);
                                case 114:
                                    if (_.
                                        default.AudioNode = new l.
                                        default (O.audioCtx), !f.
                                        default.browser.isChrome || f.
                                        default.isAndroidBrowser()) {
                                        e.next = 127;
                                        break
                                    }
                                    return M = O.audioCtx.createMediaStreamDestination(), _.
                                default.AudioNode.connect(M), e.next = 120, O.chromeAecWorkAround(M.stream);
                                case 120:
                                    N = e.sent, O.audioDomNode || (O.audioDomNode = new Audio), O.audioDomNode.srcObject = N, n.speakerInfo && n.speakerInfo.defaultDeviceId ? O.audioDomNode.setSinkId(n.speakerInfo.defaultDeviceId).
                                    catch (function(e) {
                                        B.
                                        default.add_monitor("AODF"), _.
                                        default.Notify_APPUI(h.AUDIO_SPEAKER_SET_ERROR, null)
                                    }) : O.audioDomNode.setSinkId("default").
                                    catch (function(e) {
                                        B.
                                        default.add_monitor("AODF"), _.
                                        default.Notify_APPUI(h.AUDIO_SPEAKER_SET_ERROR, null)
                                    }), O.audioDomNode.play(), e.next = 128;
                                    break;
                                case 127:
                                    _.
                                default.AudioNode.connect(O.audioCtx.destination);
                                case 128:
                                    P = new MessageChannel, b = new MessageChannel, _.
                                default.AudioNode.port.postMessage({
                                ...
                                default.AudioNode.port.postMessage({
                                    status: "sampleRate",
                                    data: O.audioCtx.sampleRate
                                }), E.Notify_Audio_Thread_Msg_Channel(P, b), O.Start_Audio_Play(), this.isSupportOffscreenCanvas && (k = new MessageChannel, E.Notify_Audio_Video_Thread_Msg_Channel(k), E.Notify_Audio_Thread_Msg_Channel2(k)), n.CaptureAudio && (O.audioCapture = n.CaptureAudioInfo, O.Start_Audio_Capture(), this.firstSetDelay && (this.firstSetDelay = !1, E.Reset_Aec(), E.Set_Aec_Delay())), e.next = 141;
                                break;
                                case 139:
                                ...
                                case 143:
                                    e.prev = 143, e.t1 = e.
                                    catch (96), this.JsMediaSDK_Log(e.t1);
                                case 146:
                                    return e.abrupt("break", 226);
                                case 147:
                                    return J("sdk start remote control 1"), w = this.sharingWidthAndHeightInfo, L = new g.
                                default ((0, d.
                                    default)({
                                    dom: document
                                }, n)), this.remoteControl = L, J("sharingInfo", w), L.setDstWidthAndHeight(w.logicWidth, w.logicHeight), L.setSrcWidthAndHeight(w.logicWidth, w.logicHeight), L.setSrcScaleWidthAndHeight(n.scaleWidth, n.scaleHeight), L.setSrcOffsetXY(n.srcOffsetX, n.srcOffsetY), L.setRemoteOS(n.os), e.abrupt("return", L.start().then(function(e) {
                                        return _.
                                        default.Notify_APPUI(e ? h.START_REMOTE_CONTROL_SUCCESS : h.START_REMOTE_CONTROL_FAILED), e && (L.onPasteTextLengthOverflow(function() {
                                            _.
                                            default.Notify_APPUI(h.REMOTE_CONTROL_PASTE_TEXT_LENGTH_OVERFLOW)
                                        }), L.onReturnCopiedText(function(e) {
                                            J(e), _.
                                            default.Notify_APPUI(h.REMOTE_CONTROL_COPIED_TEXT_NOTIFY, e)
                                        })), e
                                    }).
                                    catch (function(e) {
                                        return J(e), _.
                                        default.Notify_APPUI(h.START_REMOTE_CONTROL_FAILED), B.
                                        default.add_monitor(["RMCT", e.message, "f"].join("")), a.
                                        default.reject(e)
                                    }));
                                case 159:
                                    return e.abrupt("return", this.remoteControl.destroy().then(function(e) {
                                        return _.
                                        default.Notify_APPUI(e ? h.CANCEL_REMOTE_CONTROL_SUCCESS : h.CANCEL_REMOTE_CONTROL_FAILED), e
                                    }));
                                case 161:
                                    return this.remoteControl && (n.scaleWidth && n.scaleHeight && this.remoteControl.setSrcScaleWidthAndHeight(n.scaleWidth, n.scaleHeight), (n.srcOffsetX || n.srcOffsetY) && this.remoteControl.setSrcOffsetXYAndSendPDU(n.srcOffsetX, n.srcOffsetY), (0, R.
                                        default)(n.isControllerNow) && this.remoteControl.setIsControlerNow(n.isControllerNow), (0, y.
                                        default)(n.os) && this.remoteControl.setRemoteOS(n.os)), e.abrupt("break", 226);
                                case 163:
                                    return this.remoteControl && this.remoteControl.sendPostionPDU(), e.abrupt("break", 226);
                                case 165:
                                    if (this.flipSend = !0, n.mode ? this.isSupportImageCapture = f.
                                        default.isSupportImageCapture() : this.isSupportImageCapture = !1, this.isStartDesktopSharing) {
                                        e.next = 177;
                                        break
                                    }
                                    E.Update_Sharing_Encrpt(_.
                                        default.e2eencrypt), this.isStartDesktopSharing = !0, this.desktopSharingSend = !0, n.video = f.
                                default.getDocumentHandle(n.video), n.canvas = f.
                                default.getDocumentHandle(n.canvas), this.desktopSharingValue = n, this.Start_Desktop_Sharing(), e.next = 178;
                                break;
                                case 177:
                                    return e.abrupt("return");
                                case 178:
                                ...
                                case 204:
                                    return e.abrupt("break", 226);
                                case 205:
                                    return "kgjfgplpablkjnlkjmjdecgdpfankdle", (U = document.createElement("img")).src = "chrome-extension://kgjfgplpablkjnlkjmjdecgdpfankdle/images/trash.png", U.onload = function() {
                                        _.
                                        default.Notify_APPUI(h.CHECK_CHROME_SHARING_EXTENSION_RESPONSE, !0)
                                    }, U.onerror = function() {
                                        _.
                                        default.Notify_APPUI(h.CHECK_CHROME_SHARING_EXTENSION_RESPONSE, !1)
                                    }, e.abrupt("break", 226);
                                case 211:
                                    ...
                                    return e.abrupt("return");
                                case 215:
                                    e.t2 = n.answer.type, e.next = e.t2 === m.ZOOM_CONNECTION_TYPE.ZOOM_CONNECTION_VIDEO ? 218 : e.t2 === m.ZOOM_CONNECTION_TYPE.ZOOM_CONNECTION_AUDIO ? 220 : 222;
                                    break;
                                case 218:
                                    return A.
                                default.trigger(h.PUBSUB_EVT.ZOOM_CONNECTION_VIDEO_OFFER_RESPONSE_EVT, n), e.abrupt("break", 222);
                                case 220:
                                    return A.
                                default.trigger(h.PUBSUB_EVT.ZOOM_CONNECTION_AUDIO_OFFER_RESPONSE_EVT, n), e.abrupt("break", 222);
                                case 222:
                                    return e.abrupt("break", 226);
                                case 223:
                                    return E.setUserNodeListToWorker(n), e.abrupt("break", 226);
                                case 225:
                ...
                JsMediaSDK_OnAudioprocess: function(e) {
                    if (this.audioPlay) {
                        ...
                        if (n) {
                            ...
                            this.JsMediaSDK_Log("Active Queue  audio:" + E.Get_Decoded_Audio_Buffer_Length());
                            for (i = 0; i < t; ++i) {
                ...
                destroy: (M = (0, s.
                    ...
                    default.mark(function e() {
                        ...
                        default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    J("destroy"), this.isDestroy = !0, this.EndMedia(), E.Stop_Monitor(), E.destroyAllWorkers(), A.
                                default.clearAllSubscriptions();
                                case 6:
                                case "end":
                                    return e.stop()
        ...
        function(e, t, n) {
            ...
            function() {
                window.getScreenId = function(e, t) {
                    i.
                    default.browser.isFirefox ? e(null, "firefox", {
                        video: {
                            mediaSource: "screen"
                        }
                    }) : (window.addEventListener("message", function t(n) {
                        if (!n.data) return;
                        n.data.typ && ("WCL.PermissionDeniedError" === n.data.typ || "WCL.extensionUninstalled" == n.data.typ || "WCL.userCancel" == n.data.typ ? e(n.data.typ) : "WCL.PermisssionOK" == n.data.typ && e(null, n.data.chromeMediaSourceId, function(e, t) {
                            var n = {
                                audio: !1,
                                video: {
                                    mandatory: {
                            ...
                            t && (n.video.mandatory.chromeMediaSourceId = t, n.audio && n.audio.mandatory && (n.audio.mandatory.chromeMediaSourceId = t));
                            return n
                        }(null, n.data.chromeMediaSourceId)), window.removeEventListener("message", t))
                    }), window.postMessage({
                        captureSourceId: !0
                    }, "*"))
                }
            ...
            var a = r(n(8)),
                ...
                A = function() {
                    function e() {
                        var t = this;
                        (0, d.
                            default)(this, e), this.rtcPeerConnection = null, this.dataChannel = null, this.dataChannelLabel = null, this.messageListener = null, this.rtcPeerConnectionCreatedListener = null, this.reconnectCount = 0, this.reconnectMax = 10, this.reconnectCountBetweenCloseAndOpenAndSetTo0WhenDCOpen = 0, this.connectionID = null, this.pubSubTokenList = [], this.isForceClosed = !1, this.SEND_VIDEO_PUB_SUB_EVENT = "RTCPeerConnectionUtil.VIDEO.SENDDATA", this.reconnectRTCPeerConnectionThrottle = (0, E.
                            default)(function() {
                    ...
                    return (0, c.
                        ...
                        value: (t = (0, s.
                            ...
                            default.mark(function e(t) {
                                ...
                                default.wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            if (n = r.length > 1 && void 0 !== r[1] ? r[1] : "ZoomWebclientVideoDataChannel", _.
                                                default.add_monitor("DCCONN"), this.isSupportDataChannel()) {
                                                e.next = 4;
                                                break
                                            }
                                            return e.abrupt("return");
                                        case 4:
                                            return this.dataChannelLabel = n, this.connectionID = t, this.rtcPeerConnection = new RTCPeerConnection({
                                                ...
                                                "failed" !== t.iceConnectionState && "disconnected" !== t.iceConnectionState && "closed" !== t.iceConnectionState || (S("".concat(i.dataChannelLabel, " iceconnectionstatechange"), t.iceConnectionState), _.
                                                    default.add_monitor("ICECONNSTATECHANGE:" + i.dataChannelLabel), t.close())
                                                ...
                                                var e = (0, s.
                                                    ...
                                                    default.mark(function e(n) {
                                                        ...
                                                        default.wrap(function(e) {
                                                            for (;;) switch (e.prev = e.next) {
                                                                case 0:
                                                                    return S("original offer", (0, u.
                                                                        default)(n)), n.sdp = n.sdp.replace(/a=ice-ufrag:.+/g, "a=ice-ufrag:".concat(t)), S("modified offer", n), e.abrupt("return", i.rtcPeerConnection.setLocalDescription(n));
                                                                case 4:
                                                                case "end":
                                                                    return e.stop()
                                                            }
                        ...
                        value: function() {
                            _.
                            default.add_monitor("RTCPeerConnUtil.CLOSE");
                            try {
                                try {
                        ...
                        value: function() {
                            _.
                            default.add_monitor("DCFORCECLOSE:" + this.dataChannelLabel), S("forceClose : " + this.dataChannelLabel), this.isForceClosed = !0, this.clear(), this.close()
                        }
                    }, {
                        key: "clear",
                        value: function() {
                        ...
                        value: function() {
                            var e = this,
                                ...
                                a = 0,
                                o = f.
                            default.on(this.SEND_VIDEO_PUB_SUB_EVENT, function(o, u) {
                                if (n) {
                                    var s = (new Date).getTime() / 1e3;
                                    if ((t = s - n) > 10) {
                                        var d = r - e.dataChannel.bufferedAmount;
                                        0 == e.dataChannel.bufferedAmount ? i = i ? .8 * i + 16e4 : 8e5 : (d, a = 8 * d / (1 * t), i = i ? .8 * i + .2 * a : 8e5), f.
                                        default.publish(h.PUBSUB_EVT.VIDEO_DATACHANNEL_SPEED, i), r -= d, n = s
                                    }
                        ...
                        value: function(e) {
                            setTimeout(function() {
                                _.
                                default.send_instant_monitor(), _.
                                default.add_monitor(e), _.
                                default.send_instant_monitor()
                            }, 0)
                        }
                    }, {
                        ...
                        value: function() {
                            ...
                            t.binaryType = "arraybuffer", t.addEventListener("open", function(t) {
                                e.reconnectCountBetweenCloseAndOpenAndSetTo0WhenDCOpen = 0, clearInterval(e.timeoutThenCloseInterval), _.
                                default.add_monitor("DCOPEN:" + e.dataChannelLabel), e.oneSingleLineLog("".concat(p.MONITOR_LOG_DASHBOARD_DATACHANNEL_PARSE_SEPARATOR, ",").concat(e.userid, ",").concat(e.connectionType, ",DCOPEN,").concat(p.MONITOR_LOG_DASHBOARD_DATACHANNEL_PARSE_SEPARATOR)), S("dataChannel.onopen", t)
                            }), t.addEventListener("close", function(t) {
                                clearInterval(e.timeoutThenCloseInterval), S("dataChannel.onclose", t), _.
                                default.add_monitor("DCCLOSE:" + e.dataChannelLabel), e.oneSingleLineLog("".concat(p.MONITOR_LOG_DASHBOARD_DATACHANNEL_PARSE_SEPARATOR, ",").concat(e.userid, ",").concat(e.connectionType, ",DCCLOSE,").concat(p.MONITOR_LOG_DASHBOARD_DATACHANNEL_PARSE_SEPARATOR)), e.clear(), e.close(), e.reconnectRTCPeerConnectionThrottle()
                            }), t.addEventListener("error", function(t) {
                                clearInterval(e.timeoutThenCloseInterval), _.
                                default.add_monitor("DCERROR:".concat(e.dataChannelLabel, ":") + t.message), S("dataChannel.onerror", t)
                        ...
                        value: function(e) {
                            ...
                            f.
                            default.publish(this.SEND_VIDEO_PUB_SUB_EVENT, e)
                        }
                    }, {
                        key: "sendAudioData",
                        value: function(e) {
        ...
        function(e, t, n) {
            ...
            function c(e) {
                ...
                default, this.vMonitorCount = 0, this.videoQueue = new d.VideoQueueMGR
            }
            c.prototype.JsMediaSDK_VideoRender = function() {
                        ...
                        for (e = 0; e < this.videoRenderArray.length; e++) {
                            ...
                            if (t) {
                                if (this.videoBufEmptyCount = 0, this.videoBufCount = this.Get_Decoded_Video_Buffer_Length(this.currentactive), this.renderPeriodCount == this.renderPeriodTotal) {
                                    ...
                                    n && 0 != n || (n || console.log("fps error"), n = 100);
                                ...
                                this.currentVideoHeight == s.height && this.currentVideoWidth == s.width || (this.Notify_APPUI ? this.Notify_APPUI(a.CURRENT_VIDEO_RESOLUTION, {
                                    ...
                                    data: "VDGLW"
                                }), this.vMonitorCount = 0), this.vMonitorCount++, this.videoRenderArray[e].display.drawNextOuptutPictureGL(t.width, t.height, s, t.yuvdata, t.rotation, t.yuv_limited)) : console.error("invalid yuv data" + t.r_x + " " + t.r_y + " " + t.r_w + " " + t.r_h + " " + t.width + " " + t.height)
                ...
                if (this.videoRenderArray = e, this.videoRenderArray.length > 0)
                    for (var t = 0; t < this.videoRenderArray.length; t++) this.videoRenderArray[t].display = new s.
                default (this.videoRenderArray[t].canvas)
        ...
        function(e, t, n) {
            ...
            function d(e) {
                ...
                default, this.sMonitorCount = 0, this.mMonitorCount = 0
            }
            ...
            }, d.prototype.updateOffscreenCanvasSize = function(e, t) {
                try {
                    var n = this.sharingDisplay.canvasElement;
                    n && n instanceof OffscreenCanvas && (n.width = e, n.height = t)
                } catch (e) {
